...
namespace GDWInnovations.TagorClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.1.3/csharp");
            BasePath = "https://localhost/v1/web";
        ...
        public Configuration(
            ...
            string basePath = "https://localhost/v1/web") : this()
        {
        ...
        {
            string report = "C# SDK (GDWInnovations.TagorClient) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2.00.0000B1\n";
