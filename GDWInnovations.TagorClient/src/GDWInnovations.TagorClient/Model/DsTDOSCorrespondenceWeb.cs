...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dsTDOSCorrespondenceWeb")]
    public partial class DsTDOSCorrespondenceWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSCorrespondenceWeb" /> class.
        /// </summary>
        /// <param name="varDsTDOSCorrespondenceWeb">varDsTDOSCorrespondenceWeb.</param>
        public DsTDOSCorrespondenceWeb(DsTDOSCorrespondenceWebDsTDOSCorrespondenceWeb varDsTDOSCorrespondenceWeb = default(DsTDOSCorrespondenceWebDsTDOSCorrespondenceWeb))
        {
            this.VarDsTDOSCorrespondenceWeb = varDsTDOSCorrespondenceWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTDOSCorrespondenceWeb
        /// </summary>
        [DataMember(Name = "dsTDOSCorrespondenceWeb", EmitDefaultValue = false)]
        public DsTDOSCorrespondenceWebDsTDOSCorrespondenceWeb VarDsTDOSCorrespondenceWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSCorrespondenceWeb {\n");
            sb.Append("  VarDsTDOSCorrespondenceWeb: ").Append(VarDsTDOSCorrespondenceWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
