...
{
    /// <summary>
    /// DsTDOSPARWebDsTDOSPARWeb
    /// </summary>
    [DataContract(Name = "dsTDOSPARWeb_dsTDOSPARWeb")]
    public partial class DsTDOSPARWebDsTDOSPARWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSPARWebDsTDOSPARWeb" /> class.
        /// </summary>
        /// <param name="ttTDOSPARWeb">ttTDOSPARWeb.</param>
        public DsTDOSPARWebDsTDOSPARWeb(List<DsTDOSPARWebDsTDOSPARWebTtTDOSPARWebInner> ttTDOSPARWeb = default(List<DsTDOSPARWebDsTDOSPARWebTtTDOSPARWebInner>))
        {
            this.TtTDOSPARWeb = ttTDOSPARWeb;
        }

        /// <summary>
        /// Gets or Sets TtTDOSPARWeb
        /// </summary>
        [DataMember(Name = "ttTDOSPARWeb", EmitDefaultValue = false)]
        public List<DsTDOSPARWebDsTDOSPARWebTtTDOSPARWebInner> TtTDOSPARWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSPARWebDsTDOSPARWeb {\n");
            sb.Append("  TtTDOSPARWeb: ").Append(TtTDOSPARWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
