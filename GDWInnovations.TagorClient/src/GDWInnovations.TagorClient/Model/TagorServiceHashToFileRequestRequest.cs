...
{
    /// <summary>
    /// TagorServiceHashToFileRequestRequest
    /// </summary>
    [DataContract(Name = "TagorServiceHashToFile_request_request")]
    public partial class TagorServiceHashToFileRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceHashToFileRequestRequest" /> class.
        /// </summary>
        /// <param name="dossierhash">This field is case-sensitive..</param>
        public TagorServiceHashToFileRequestRequest(string dossierhash = default(string))
        {
            this.Dossierhash = dossierhash;
        }

        /// <summary>
        /// This field is case-sensitive.
        /// </summary>
        /// <value>This field is case-sensitive.</value>
        [DataMember(Name = "Dossierhash", EmitDefaultValue = false)]
        public string Dossierhash { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceHashToFileRequestRequest {\n");
            sb.Append("  Dossierhash: ").Append(Dossierhash).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
