...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DocumentGetRequest
    /// </summary>
    [DataContract(Name = "DocumentGet_request")]
    public partial class DocumentGetRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentGetRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public DocumentGetRequest(CodeGetListRequestRequest request = default(CodeGetListRequestRequest))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentGetRequest {\n");
