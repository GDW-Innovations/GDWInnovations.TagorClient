...
{
    /// <summary>
    /// DsConfigWebDsConfigWebTtConfigWebInner
    /// </summary>
    [DataContract(Name = "dsConfigWeb_dsConfigWeb_ttConfigWeb_inner")]
    public partial class DsConfigWebDsConfigWebTtConfigWebInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsConfigWebDsConfigWebTtConfigWebInner" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="typeId">typeId.</param>
        /// <param name="typeCode">typeCode.</param>
        public DsConfigWebDsConfigWebTtConfigWebInner(string data = default(string), string typeId = default(string), string typeCode = default(string))
        {
            this.Data = data;
            this.TypeId = typeId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsConfigWebDsConfigWebTtConfigWebInner {\n");
