...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsFilterDsFilter
    /// </summary>
    [DataContract(Name = "dsFilter_dsFilter")]
    public partial class DsFilterDsFilter : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsFilterDsFilter" /> class.
        /// </summary>
        /// <param name="ttFilter">ttFilter.</param>
        public DsFilterDsFilter(List<DsFilterDsFilterTtFilterInner> ttFilter = default(List<DsFilterDsFilterTtFilterInner>))
        {
            this.TtFilter = ttFilter;
        }

        /// <summary>
        /// Gets or Sets TtFilter
        /// </summary>
        [DataMember(Name = "ttFilter", EmitDefaultValue = false)]
        public List<DsFilterDsFilterTtFilterInner> TtFilter { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsFilterDsFilter {\n");
            sb.Append("  TtFilter: ").Append(TtFilter).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
