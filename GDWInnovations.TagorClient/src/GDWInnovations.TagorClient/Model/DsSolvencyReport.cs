...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsSolvencyReport
    /// </summary>
    [DataContract(Name = "dsSolvencyReport")]
    public partial class DsSolvencyReport : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsSolvencyReport" /> class.
        /// </summary>
        /// <param name="varDsSolvencyReport">varDsSolvencyReport.</param>
        public DsSolvencyReport(DsSolvencyReportDsSolvencyReport varDsSolvencyReport = default(DsSolvencyReportDsSolvencyReport))
        {
            this.VarDsSolvencyReport = varDsSolvencyReport;
        }

        /// <summary>
        /// Gets or Sets VarDsSolvencyReport
        /// </summary>
        [DataMember(Name = "dsSolvencyReport", EmitDefaultValue = false)]
        public DsSolvencyReportDsSolvencyReport VarDsSolvencyReport { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsSolvencyReport {\n");
            sb.Append("  VarDsSolvencyReport: ").Append(VarDsSolvencyReport).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
