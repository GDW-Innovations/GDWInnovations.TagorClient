...
{
    /// <summary>
    /// DsTDOSLIJNWebDsTDOSLIJNWeb
    /// </summary>
    [DataContract(Name = "dsTDOSLIJNWeb_dsTDOSLIJNWeb")]
    public partial class DsTDOSLIJNWebDsTDOSLIJNWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSLIJNWebDsTDOSLIJNWeb" /> class.
        /// </summary>
        /// <param name="ttTDOSLIJNWeb">ttTDOSLIJNWeb.</param>
        public DsTDOSLIJNWebDsTDOSLIJNWeb(List<DsTDOSLIJNWebDsTDOSLIJNWebTtTDOSLIJNWebInner> ttTDOSLIJNWeb = default(List<DsTDOSLIJNWebDsTDOSLIJNWebTtTDOSLIJNWebInner>))
        {
            this.TtTDOSLIJNWeb = ttTDOSLIJNWeb;
        }

        /// <summary>
        /// Gets or Sets TtTDOSLIJNWeb
        /// </summary>
        [DataMember(Name = "ttTDOSLIJNWeb", EmitDefaultValue = false)]
        public List<DsTDOSLIJNWebDsTDOSLIJNWebTtTDOSLIJNWebInner> TtTDOSLIJNWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSLIJNWebDsTDOSLIJNWeb {\n");
            sb.Append("  TtTDOSLIJNWeb: ").Append(TtTDOSLIJNWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
