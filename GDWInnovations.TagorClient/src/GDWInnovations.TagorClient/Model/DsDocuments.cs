...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsDocuments
    /// </summary>
    [DataContract(Name = "dsDocuments")]
    public partial class DsDocuments : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsDocuments" /> class.
        /// </summary>
        /// <param name="varDsDocuments">varDsDocuments.</param>
        public DsDocuments(DsDocumentsDsDocuments varDsDocuments = default(DsDocumentsDsDocuments))
        {
            this.VarDsDocuments = varDsDocuments;
        }

        /// <summary>
        /// Gets or Sets VarDsDocuments
        /// </summary>
        [DataMember(Name = "dsDocuments", EmitDefaultValue = false)]
        public DsDocumentsDsDocuments VarDsDocuments { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsDocuments {\n");
            sb.Append("  VarDsDocuments: ").Append(VarDsDocuments).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
