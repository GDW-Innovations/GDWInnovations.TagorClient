...
{
    /// <summary>
    /// DossierGetByDefendant200ResponseResponse
    /// </summary>
    [DataContract(Name = "DossierGetByDefendant_200_response_response")]
    public partial class DossierGetByDefendant200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierGetByDefendant200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTDOSWeb">dsTDOSWeb.</param>
        public DossierGetByDefendant200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTDOSDefendantWeb dsTDOSWeb = default(DsTDOSDefendantWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTDOSWeb = dsTDOSWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTDOSWeb
        /// </summary>
        [DataMember(Name = "dsTDOSWeb", EmitDefaultValue = false)]
        public DsTDOSDefendantWeb DsTDOSWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierGetByDefendant200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTDOSWeb: ").Append(DsTDOSWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
