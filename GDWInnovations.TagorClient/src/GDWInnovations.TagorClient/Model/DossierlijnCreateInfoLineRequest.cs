...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DossierlijnCreateInfoLine_request")]
    public partial class DossierlijnCreateInfoLineRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierlijnCreateInfoLineRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public DossierlijnCreateInfoLineRequest(DossierlijnGetInfo200ResponseResponse request = default(DossierlijnGetInfo200ResponseResponse))
        {
        ...
        public DossierlijnGetInfo200ResponseResponse Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierlijnCreateInfoLineRequest {\n");
