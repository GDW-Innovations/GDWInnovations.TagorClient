...
{
    /// <summary>
    /// DsTDOSTITELWebDsTDOSTITELWebTtTDOSTITELWebInner
    /// </summary>
    [DataContract(Name = "dsTDOSTITELWeb_dsTDOSTITELWeb_ttTDOSTITELWeb_inner")]
    public partial class DsTDOSTITELWebDsTDOSTITELWebTtTDOSTITELWebInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSTITELWebDsTDOSTITELWebTtTDOSTITELWebInner" /> class.
        /// </summary>
        ...
        /// <param name="timeStampTitel">timeStampTitel.</param>
        /// <param name="omschrijving">omschrijving.</param>
        public DsTDOSTITELWebDsTDOSTITELWebTtTDOSTITELWebInner(string tQRBId = default(string), string tQKAMERId = default(string), string owningRBEntity = default(string), string owningRBId = default(string), string timeStampTitel = default(string), string omschrijving = default(string))
        {
            this.TQRBId = tQRBId;
            this.TQKAMERId = tQKAMERId;
            this.OwningRBEntity = owningRBEntity;
            this.OwningRBId = owningRBId;
            this.TimeStampTitel = timeStampTitel;
        ...
        /// <summary>
        /// Gets or Sets TimeStampTitel
        /// </summary>
        [DataMember(Name = "TimeStampTitel", EmitDefaultValue = false)]
        public string TimeStampTitel { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSTITELWebDsTDOSTITELWebTtTDOSTITELWebInner {\n");
            ...
            sb.Append("  TimeStampTitel: ").Append(TimeStampTitel).Append("\n");
