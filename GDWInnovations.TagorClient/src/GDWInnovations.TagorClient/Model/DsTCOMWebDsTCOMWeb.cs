...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsTCOMWebDsTCOMWeb
    /// </summary>
    [DataContract(Name = "dsTCOMWeb_dsTCOMWeb")]
    public partial class DsTCOMWebDsTCOMWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTCOMWebDsTCOMWeb" /> class.
        /// </summary>
        /// <param name="ttTCOMWeb">ttTCOMWeb.</param>
        public DsTCOMWebDsTCOMWeb(List<DsTCOMWebDsTCOMWebTtTCOMWebInner> ttTCOMWeb = default(List<DsTCOMWebDsTCOMWebTtTCOMWebInner>))
        {
            this.TtTCOMWeb = ttTCOMWeb;
        }

        /// <summary>
        /// Gets or Sets TtTCOMWeb
        /// </summary>
        [DataMember(Name = "ttTCOMWeb", EmitDefaultValue = false)]
        public List<DsTCOMWebDsTCOMWebTtTCOMWebInner> TtTCOMWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTCOMWebDsTCOMWeb {\n");
            sb.Append("  TtTCOMWeb: ").Append(TtTCOMWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
