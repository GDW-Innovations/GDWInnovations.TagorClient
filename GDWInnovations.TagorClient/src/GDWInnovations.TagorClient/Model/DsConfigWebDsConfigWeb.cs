...
{
    /// <summary>
    /// DsConfigWebDsConfigWeb
    /// </summary>
    [DataContract(Name = "dsConfigWeb_dsConfigWeb")]
    public partial class DsConfigWebDsConfigWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsConfigWebDsConfigWeb" /> class.
        /// </summary>
        /// <param name="ttConfigWeb">ttConfigWeb.</param>
        public DsConfigWebDsConfigWeb(List<DsConfigWebDsConfigWebTtConfigWebInner> ttConfigWeb = default(List<DsConfigWebDsConfigWebTtConfigWebInner>))
        {
            this.TtConfigWeb = ttConfigWeb;
        }

        /// <summary>
        /// Gets or Sets TtConfigWeb
        /// </summary>
        [DataMember(Name = "ttConfigWeb", EmitDefaultValue = false)]
        public List<DsConfigWebDsConfigWebTtConfigWebInner> TtConfigWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsConfigWebDsConfigWeb {\n");
            sb.Append("  TtConfigWeb: ").Append(TtConfigWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
