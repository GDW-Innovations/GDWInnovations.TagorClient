...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsTDOSWebDsTDOSWeb
    /// </summary>
    [DataContract(Name = "dsTDOSWeb_dsTDOSWeb")]
    public partial class DsTDOSWebDsTDOSWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSWebDsTDOSWeb" /> class.
        /// </summary>
        /// <param name="ttTDOSWeb">ttTDOSWeb.</param>
        public DsTDOSWebDsTDOSWeb(List<DsTDOSWebDsTDOSWebTtTDOSWebInner> ttTDOSWeb = default(List<DsTDOSWebDsTDOSWebTtTDOSWebInner>))
        {
            this.TtTDOSWeb = ttTDOSWeb;
        }

        /// <summary>
        /// Gets or Sets TtTDOSWeb
        /// </summary>
        [DataMember(Name = "ttTDOSWeb", EmitDefaultValue = false)]
        public List<DsTDOSWebDsTDOSWebTtTDOSWebInner> TtTDOSWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSWebDsTDOSWeb {\n");
            sb.Append("  TtTDOSWeb: ").Append(TtTDOSWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
