...
{
    /// <summary>
    /// DsClipToFileDossiersDsClipToFileDossiersTtClipToFileDossiersInner
    /// </summary>
    [DataContract(Name = "dsClipToFileDossiers_dsClipToFileDossiers_ttClipToFileDossiers_inner")]
    public partial class DsClipToFileDossiersDsClipToFileDossiersTtClipToFileDossiersInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsClipToFileDossiersDsClipToFileDossiersTtClipToFileDossiersInner" /> class.
        /// </summary>
        ...
        public DsClipToFileDossiersDsClipToFileDossiersTtClipToFileDossiersInner(string tDOSId = default(string), string dossiernaam = default(string), string tQDOSSOORTId = default(string), decimal saldoVerw = default(decimal))
        {
            this.TDOSId = tDOSId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsClipToFileDossiersDsClipToFileDossiersTtClipToFileDossiersInner {\n");
