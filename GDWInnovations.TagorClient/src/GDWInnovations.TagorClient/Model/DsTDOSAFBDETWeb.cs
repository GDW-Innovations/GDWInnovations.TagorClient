...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsTDOSAFBDETWeb
    /// </summary>
    [DataContract(Name = "dsTDOSAFBDETWeb")]
    public partial class DsTDOSAFBDETWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSAFBDETWeb" /> class.
        /// </summary>
        /// <param name="varDsTDOSAFBDETWeb">varDsTDOSAFBDETWeb.</param>
        public DsTDOSAFBDETWeb(DsTDOSAFBDETWebDsTDOSAFBDETWeb varDsTDOSAFBDETWeb = default(DsTDOSAFBDETWebDsTDOSAFBDETWeb))
        {
            this.VarDsTDOSAFBDETWeb = varDsTDOSAFBDETWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTDOSAFBDETWeb
        /// </summary>
        [DataMember(Name = "dsTDOSAFBDETWeb", EmitDefaultValue = false)]
        public DsTDOSAFBDETWebDsTDOSAFBDETWeb VarDsTDOSAFBDETWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSAFBDETWeb {\n");
            sb.Append("  VarDsTDOSAFBDETWeb: ").Append(VarDsTDOSAFBDETWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
