...
{
    /// <summary>
    /// TagorServiceClipToFileRequestRequest
    /// </summary>
    [DataContract(Name = "TagorServiceClipToFile_request_request")]
    public partial class TagorServiceClipToFileRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceClipToFileRequestRequest" /> class.
        /// </summary>
        /// <param name="telnr">telnr.</param>
        public TagorServiceClipToFileRequestRequest(string telnr = default(string))
        {
            this.Telnr = telnr;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceClipToFileRequestRequest {\n");
