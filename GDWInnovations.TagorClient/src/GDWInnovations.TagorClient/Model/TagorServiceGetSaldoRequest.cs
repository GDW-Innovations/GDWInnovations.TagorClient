...
{
    /// <summary>
    /// TagorServiceGetSaldoRequest
    /// </summary>
    [DataContract(Name = "TagorServiceGetSaldo_request")]
    public partial class TagorServiceGetSaldoRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceGetSaldoRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public TagorServiceGetSaldoRequest(TagorServiceGetSaldoRequestRequest request = default(TagorServiceGetSaldoRequestRequest))
        {
        ...
        public TagorServiceGetSaldoRequestRequest Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceGetSaldoRequest {\n");
