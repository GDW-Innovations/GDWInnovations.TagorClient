...
{
    /// <summary>
    /// DsTDOSINFOWebDsTDOSINFOWeb
    /// </summary>
    [DataContract(Name = "dsTDOSINFOWeb_dsTDOSINFOWeb")]
    public partial class DsTDOSINFOWebDsTDOSINFOWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSINFOWebDsTDOSINFOWeb" /> class.
        /// </summary>
        /// <param name="ttTDOSINFOWeb">ttTDOSINFOWeb.</param>
        public DsTDOSINFOWebDsTDOSINFOWeb(List<DsTDOSINFOWebDsTDOSINFOWebTtTDOSINFOWebInner> ttTDOSINFOWeb = default(List<DsTDOSINFOWebDsTDOSINFOWebTtTDOSINFOWebInner>))
        {
            this.TtTDOSINFOWeb = ttTDOSINFOWeb;
        }

        /// <summary>
        /// Gets or Sets TtTDOSINFOWeb
        /// </summary>
        [DataMember(Name = "ttTDOSINFOWeb", EmitDefaultValue = false)]
        public List<DsTDOSINFOWebDsTDOSINFOWebTtTDOSINFOWebInner> TtTDOSINFOWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSINFOWebDsTDOSINFOWeb {\n");
            sb.Append("  TtTDOSINFOWeb: ").Append(TtTDOSINFOWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
