...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsTDOSWeb
    /// </summary>
    [DataContract(Name = "dsTDOSWeb")]
    public partial class DsTDOSWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSWeb" /> class.
        /// </summary>
        /// <param name="varDsTDOSWeb">varDsTDOSWeb.</param>
        public DsTDOSWeb(DsTDOSWebDsTDOSWeb varDsTDOSWeb = default(DsTDOSWebDsTDOSWeb))
        {
            this.VarDsTDOSWeb = varDsTDOSWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTDOSWeb
        /// </summary>
        [DataMember(Name = "dsTDOSWeb", EmitDefaultValue = false)]
        public DsTDOSWebDsTDOSWeb VarDsTDOSWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSWeb {\n");
            sb.Append("  VarDsTDOSWeb: ").Append(VarDsTDOSWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
