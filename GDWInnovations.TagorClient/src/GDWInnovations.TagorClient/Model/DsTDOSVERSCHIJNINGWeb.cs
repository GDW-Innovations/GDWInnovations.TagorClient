...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dsTDOSVERSCHIJNINGWeb")]
    public partial class DsTDOSVERSCHIJNINGWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSVERSCHIJNINGWeb" /> class.
        /// </summary>
        /// <param name="varDsTDOSVERSCHIJNINGWeb">varDsTDOSVERSCHIJNINGWeb.</param>
        public DsTDOSVERSCHIJNINGWeb(DsTDOSVERSCHIJNINGWebDsTDOSVERSCHIJNINGWeb varDsTDOSVERSCHIJNINGWeb = default(DsTDOSVERSCHIJNINGWebDsTDOSVERSCHIJNINGWeb))
        {
            this.VarDsTDOSVERSCHIJNINGWeb = varDsTDOSVERSCHIJNINGWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTDOSVERSCHIJNINGWeb
        /// </summary>
        [DataMember(Name = "dsTDOSVERSCHIJNINGWeb", EmitDefaultValue = false)]
        public DsTDOSVERSCHIJNINGWebDsTDOSVERSCHIJNINGWeb VarDsTDOSVERSCHIJNINGWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSVERSCHIJNINGWeb {\n");
            sb.Append("  VarDsTDOSVERSCHIJNINGWeb: ").Append(VarDsTDOSVERSCHIJNINGWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
