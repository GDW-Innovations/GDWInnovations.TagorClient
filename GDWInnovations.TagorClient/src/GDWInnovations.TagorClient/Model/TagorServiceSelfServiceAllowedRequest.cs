...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TagorServiceSelfServiceAllowed_request")]
    public partial class TagorServiceSelfServiceAllowedRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceSelfServiceAllowedRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public TagorServiceSelfServiceAllowedRequest(TagorServiceSelfServiceAllowedRequestRequest request = default(TagorServiceSelfServiceAllowedRequestRequest))
        {
        ...
        public TagorServiceSelfServiceAllowedRequestRequest Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceSelfServiceAllowedRequest {\n");
