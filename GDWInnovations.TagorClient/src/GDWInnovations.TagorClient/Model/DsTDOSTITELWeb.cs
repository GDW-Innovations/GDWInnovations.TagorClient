...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsTDOSTITELWeb
    /// </summary>
    [DataContract(Name = "dsTDOSTITELWeb")]
    public partial class DsTDOSTITELWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSTITELWeb" /> class.
        /// </summary>
        /// <param name="varDsTDOSTITELWeb">varDsTDOSTITELWeb.</param>
        public DsTDOSTITELWeb(DsTDOSTITELWebDsTDOSTITELWeb varDsTDOSTITELWeb = default(DsTDOSTITELWebDsTDOSTITELWeb))
        {
            this.VarDsTDOSTITELWeb = varDsTDOSTITELWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTDOSTITELWeb
        /// </summary>
        [DataMember(Name = "dsTDOSTITELWeb", EmitDefaultValue = false)]
        public DsTDOSTITELWebDsTDOSTITELWeb VarDsTDOSTITELWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSTITELWeb {\n");
            sb.Append("  VarDsTDOSTITELWeb: ").Append(VarDsTDOSTITELWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
