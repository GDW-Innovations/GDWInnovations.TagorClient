...
{
    /// <summary>
    /// DossierGetByDefendantRequest
    /// </summary>
    [DataContract(Name = "DossierGetByDefendant_request")]
    public partial class DossierGetByDefendantRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierGetByDefendantRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public DossierGetByDefendantRequest(CodeGetListRequestRequest request = default(CodeGetListRequestRequest))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierGetByDefendantRequest {\n");
