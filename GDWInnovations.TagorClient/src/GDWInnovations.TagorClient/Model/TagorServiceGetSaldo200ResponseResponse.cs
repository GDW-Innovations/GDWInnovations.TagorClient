...
{
    /// <summary>
    /// TagorServiceGetSaldo200ResponseResponse
    /// </summary>
    [DataContract(Name = "TagorServiceGetSaldo_200_response_response")]
    public partial class TagorServiceGetSaldo200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceGetSaldo200ResponseResponse" /> class.
        /// </summary>
        /// <param name="success">success.</param>
        /// <param name="error">error.</param>
        /// <param name="saldo">saldo.</param>
        public TagorServiceGetSaldo200ResponseResponse(bool success = default(bool), string error = default(string), decimal saldo = default(decimal))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceGetSaldo200ResponseResponse {\n");
