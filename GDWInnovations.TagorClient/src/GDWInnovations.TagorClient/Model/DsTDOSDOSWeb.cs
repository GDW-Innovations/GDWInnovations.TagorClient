...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsTDOSDOSWeb
    /// </summary>
    [DataContract(Name = "dsTDOSDOSWeb")]
    public partial class DsTDOSDOSWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSDOSWeb" /> class.
        /// </summary>
        /// <param name="varDsTDOSDOSWeb">varDsTDOSDOSWeb.</param>
        public DsTDOSDOSWeb(DsTDOSDOSWebDsTDOSDOSWeb varDsTDOSDOSWeb = default(DsTDOSDOSWebDsTDOSDOSWeb))
        {
            this.VarDsTDOSDOSWeb = varDsTDOSDOSWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTDOSDOSWeb
        /// </summary>
        [DataMember(Name = "dsTDOSDOSWeb", EmitDefaultValue = false)]
        public DsTDOSDOSWebDsTDOSDOSWeb VarDsTDOSDOSWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSDOSWeb {\n");
            sb.Append("  VarDsTDOSDOSWeb: ").Append(VarDsTDOSDOSWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
