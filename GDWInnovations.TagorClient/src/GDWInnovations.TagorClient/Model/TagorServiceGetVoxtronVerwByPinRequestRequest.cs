...
{
    /// <summary>
    /// TagorServiceGetVoxtronVerwByPinRequestRequest
    /// </summary>
    [DataContract(Name = "TagorServiceGetVoxtronVerwByPin_request_request")]
    public partial class TagorServiceGetVoxtronVerwByPinRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceGetVoxtronVerwByPinRequestRequest" /> class.
        /// </summary>
        /// <param name="dosId">dosId.</param>
        /// <param name="pin">pin.</param>
        public TagorServiceGetVoxtronVerwByPinRequestRequest(string dosId = default(string), string pin = default(string))
        {
            this.DosId = dosId;
            this.Pin = pin;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceGetVoxtronVerwByPinRequestRequest {\n");
