...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsTPARSearch
    /// </summary>
    [DataContract(Name = "dsTPARSearch")]
    public partial class DsTPARSearch : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTPARSearch" /> class.
        /// </summary>
        /// <param name="varDsTPARSearch">varDsTPARSearch.</param>
        public DsTPARSearch(DsTPARSearchDsTPARSearch varDsTPARSearch = default(DsTPARSearchDsTPARSearch))
        {
            this.VarDsTPARSearch = varDsTPARSearch;
        }

        /// <summary>
        /// Gets or Sets VarDsTPARSearch
        /// </summary>
        [DataMember(Name = "dsTPARSearch", EmitDefaultValue = false)]
        public DsTPARSearchDsTPARSearch VarDsTPARSearch { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTPARSearch {\n");
            sb.Append("  VarDsTPARSearch: ").Append(VarDsTPARSearch).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
