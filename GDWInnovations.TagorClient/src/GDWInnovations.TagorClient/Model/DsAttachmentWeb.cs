...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsAttachmentWeb
    /// </summary>
    [DataContract(Name = "dsAttachmentWeb")]
    public partial class DsAttachmentWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsAttachmentWeb" /> class.
        /// </summary>
        /// <param name="varDsAttachmentWeb">varDsAttachmentWeb.</param>
        public DsAttachmentWeb(DsAttachmentWebDsAttachmentWeb varDsAttachmentWeb = default(DsAttachmentWebDsAttachmentWeb))
        {
            this.VarDsAttachmentWeb = varDsAttachmentWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsAttachmentWeb
        /// </summary>
        [DataMember(Name = "dsAttachmentWeb", EmitDefaultValue = false)]
        public DsAttachmentWebDsAttachmentWeb VarDsAttachmentWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsAttachmentWeb {\n");
            sb.Append("  VarDsAttachmentWeb: ").Append(VarDsAttachmentWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
