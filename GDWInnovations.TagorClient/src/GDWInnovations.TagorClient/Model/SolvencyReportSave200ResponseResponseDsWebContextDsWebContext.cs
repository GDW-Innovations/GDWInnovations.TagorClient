...
{
    /// <summary>
    /// SolvencyReportSave200ResponseResponseDsWebContextDsWebContext
    /// </summary>
    [DataContract(Name = "SolvencyReportSave_200_response_response_dsWebContext_dsWebContext")]
    public partial class SolvencyReportSave200ResponseResponseDsWebContextDsWebContext : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SolvencyReportSave200ResponseResponseDsWebContextDsWebContext" /> class.
        /// </summary>
        /// <param name="ttWebContext">ttWebContext.</param>
        public SolvencyReportSave200ResponseResponseDsWebContextDsWebContext(List<SolvencyReportSave200ResponseResponseDsWebContextDsWebContextTtWebContextInner> ttWebContext = default(List<SolvencyReportSave200ResponseResponseDsWebContextDsWebContextTtWebContextInner>))
        {
            this.TtWebContext = ttWebContext;
        }

        /// <summary>
        /// Gets or Sets TtWebContext
        /// </summary>
        [DataMember(Name = "ttWebContext", EmitDefaultValue = false)]
        public List<SolvencyReportSave200ResponseResponseDsWebContextDsWebContextTtWebContextInner> TtWebContext { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SolvencyReportSave200ResponseResponseDsWebContextDsWebContext {\n");
            sb.Append("  TtWebContext: ").Append(TtWebContext).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
