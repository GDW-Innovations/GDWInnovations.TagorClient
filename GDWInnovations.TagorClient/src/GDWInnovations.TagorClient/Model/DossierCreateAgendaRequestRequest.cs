...
{
    /// <summary>
    /// DossierCreateAgendaRequestRequest
    /// </summary>
    [DataContract(Name = "DossierCreateAgenda_request_request")]
    public partial class DossierCreateAgendaRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierCreateAgendaRequestRequest" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTAGENDAWeb">dsTAGENDAWeb.</param>
        public DossierCreateAgendaRequestRequest(DsWebContext dsWebContext = default(DsWebContext), DsTAGENDAWeb dsTAGENDAWeb = default(DsTAGENDAWeb))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierCreateAgendaRequestRequest {\n");
