...
{
    /// <summary>
    /// DossierGetTitle200ResponseResponse
    /// </summary>
    [DataContract(Name = "DossierGetTitle_200_response_response")]
    public partial class DossierGetTitle200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierGetTitle200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTDOSTITELWeb">dsTDOSTITELWeb.</param>
        public DossierGetTitle200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTDOSTITELWeb dsTDOSTITELWeb = default(DsTDOSTITELWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTDOSTITELWeb = dsTDOSTITELWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTDOSTITELWeb
        /// </summary>
        [DataMember(Name = "dsTDOSTITELWeb", EmitDefaultValue = false)]
        public DsTDOSTITELWeb DsTDOSTITELWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierGetTitle200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTDOSTITELWeb: ").Append(DsTDOSTITELWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
