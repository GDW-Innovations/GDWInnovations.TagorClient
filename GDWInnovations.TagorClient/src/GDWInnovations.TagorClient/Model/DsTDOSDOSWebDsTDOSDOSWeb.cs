...
{
    /// <summary>
    /// DsTDOSDOSWebDsTDOSDOSWeb
    /// </summary>
    [DataContract(Name = "dsTDOSDOSWeb_dsTDOSDOSWeb")]
    public partial class DsTDOSDOSWebDsTDOSDOSWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSDOSWebDsTDOSDOSWeb" /> class.
        /// </summary>
        /// <param name="ttTDOSDOSWeb">ttTDOSDOSWeb.</param>
        public DsTDOSDOSWebDsTDOSDOSWeb(List<DsTDOSDOSWebDsTDOSDOSWebTtTDOSDOSWebInner> ttTDOSDOSWeb = default(List<DsTDOSDOSWebDsTDOSDOSWebTtTDOSDOSWebInner>))
        {
            this.TtTDOSDOSWeb = ttTDOSDOSWeb;
        }

        /// <summary>
        /// Gets or Sets TtTDOSDOSWeb
        /// </summary>
        [DataMember(Name = "ttTDOSDOSWeb", EmitDefaultValue = false)]
        public List<DsTDOSDOSWebDsTDOSDOSWebTtTDOSDOSWebInner> TtTDOSDOSWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSDOSWebDsTDOSDOSWeb {\n");
            sb.Append("  TtTDOSDOSWeb: ").Append(TtTDOSDOSWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
