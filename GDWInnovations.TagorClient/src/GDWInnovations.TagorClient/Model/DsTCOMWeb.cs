...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsTCOMWeb
    /// </summary>
    [DataContract(Name = "dsTCOMWeb")]
    public partial class DsTCOMWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTCOMWeb" /> class.
        /// </summary>
        /// <param name="varDsTCOMWeb">varDsTCOMWeb.</param>
        public DsTCOMWeb(DsTCOMWebDsTCOMWeb varDsTCOMWeb = default(DsTCOMWebDsTCOMWeb))
        {
            this.VarDsTCOMWeb = varDsTCOMWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTCOMWeb
        /// </summary>
        [DataMember(Name = "dsTCOMWeb", EmitDefaultValue = false)]
        public DsTCOMWebDsTCOMWeb VarDsTCOMWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTCOMWeb {\n");
            sb.Append("  VarDsTCOMWeb: ").Append(VarDsTCOMWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
