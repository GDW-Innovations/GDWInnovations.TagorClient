...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DossierSearch_request")]
    public partial class DossierSearchRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierSearchRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public DossierSearchRequest(DossierSearchRequestRequest request = default(DossierSearchRequestRequest))
        {
        ...
        public DossierSearchRequestRequest Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierSearchRequest {\n");
