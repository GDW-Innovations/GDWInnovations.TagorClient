...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsFilter
    /// </summary>
    [DataContract(Name = "dsFilter")]
    public partial class DsFilter : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsFilter" /> class.
        /// </summary>
        /// <param name="varDsFilter">varDsFilter.</param>
        public DsFilter(DsFilterDsFilter varDsFilter = default(DsFilterDsFilter))
        {
            this.VarDsFilter = varDsFilter;
        }

        /// <summary>
        /// Gets or Sets VarDsFilter
        /// </summary>
        [DataMember(Name = "dsFilter", EmitDefaultValue = false)]
        public DsFilterDsFilter VarDsFilter { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsFilter {\n");
            sb.Append("  VarDsFilter: ").Append(VarDsFilter).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
