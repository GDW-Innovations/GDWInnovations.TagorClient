...
{
    /// <summary>
    /// DsTPARSearchDsTPARSearch
    /// </summary>
    [DataContract(Name = "dsTPARSearch_dsTPARSearch")]
    public partial class DsTPARSearchDsTPARSearch : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTPARSearchDsTPARSearch" /> class.
        /// </summary>
        /// <param name="ttTPARSearch">ttTPARSearch.</param>
        public DsTPARSearchDsTPARSearch(List<DsTPARSearchDsTPARSearchTtTPARSearchInner> ttTPARSearch = default(List<DsTPARSearchDsTPARSearchTtTPARSearchInner>))
        {
            this.TtTPARSearch = ttTPARSearch;
        }

        /// <summary>
        /// Gets or Sets TtTPARSearch
        /// </summary>
        [DataMember(Name = "ttTPARSearch", EmitDefaultValue = false)]
        public List<DsTPARSearchDsTPARSearchTtTPARSearchInner> TtTPARSearch { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTPARSearchDsTPARSearch {\n");
            sb.Append("  TtTPARSearch: ").Append(TtTPARSearch).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
