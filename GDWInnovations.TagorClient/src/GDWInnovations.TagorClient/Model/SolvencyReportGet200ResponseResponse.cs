...
{
    /// <summary>
    /// SolvencyReportGet200ResponseResponse
    /// </summary>
    [DataContract(Name = "SolvencyReportGet_200_response_response")]
    public partial class SolvencyReportGet200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SolvencyReportGet200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsSolvencyReport">dsSolvencyReport.</param>
        public SolvencyReportGet200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsSolvencyReport dsSolvencyReport = default(DsSolvencyReport))
        {
            this.DsWebContext = dsWebContext;
            this.DsSolvencyReport = dsSolvencyReport;
        }
        ...
        /// <summary>
        /// Gets or Sets DsSolvencyReport
        /// </summary>
        [DataMember(Name = "dsSolvencyReport", EmitDefaultValue = false)]
        public DsSolvencyReport DsSolvencyReport { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SolvencyReportGet200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsSolvencyReport: ").Append(DsSolvencyReport).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
