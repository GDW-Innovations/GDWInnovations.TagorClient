...
{
    /// <summary>
    /// DossierGetAgenda200ResponseResponse
    /// </summary>
    [DataContract(Name = "DossierGetAgenda_200_response_response")]
    public partial class DossierGetAgenda200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierGetAgenda200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTAGENDAWeb">dsTAGENDAWeb.</param>
        public DossierGetAgenda200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTAGENDAWeb dsTAGENDAWeb = default(DsTAGENDAWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTAGENDAWeb = dsTAGENDAWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTAGENDAWeb
        /// </summary>
        [DataMember(Name = "dsTAGENDAWeb", EmitDefaultValue = false)]
        public DsTAGENDAWeb DsTAGENDAWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierGetAgenda200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTAGENDAWeb: ").Append(DsTAGENDAWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
