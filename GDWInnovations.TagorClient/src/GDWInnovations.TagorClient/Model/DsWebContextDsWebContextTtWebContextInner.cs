...
{
    /// <summary>
    /// DsWebContextDsWebContextTtWebContextInner
    /// </summary>
    [DataContract(Name = "dsWebContext_dsWebContext_ttWebContext_inner")]
    public partial class DsWebContextDsWebContextTtWebContextInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsWebContextDsWebContextTtWebContextInner" /> class.
        /// </summary>
        /// <param name="contextKey">contextKey.</param>
        /// <param name="contextValue">contextValue.</param>
        public DsWebContextDsWebContextTtWebContextInner(string contextKey = default(string), string contextValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsWebContextDsWebContextTtWebContextInner {\n");
