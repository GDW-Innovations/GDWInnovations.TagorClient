...
{
    /// <summary>
    /// DsFilterDsFilterTtFilterInner
    /// </summary>
    [DataContract(Name = "dsFilter_dsFilter_ttFilter_inner")]
    public partial class DsFilterDsFilterTtFilterInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsFilterDsFilterTtFilterInner" /> class.
        /// </summary>
        ...
        public DsFilterDsFilterTtFilterInner(string tabel = default(string), string veld = default(string), string varOperator = default(string), string waarde = default(string))
        {
            this.Tabel = tabel;
            this.Veld = veld;
        ...
        /// Gets or Sets Veld
        /// </summary>
        [DataMember(Name = "Veld", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsFilterDsFilterTtFilterInner {\n");
            sb.Append("  Tabel: ").Append(Tabel).Append("\n");
            sb.Append("  Veld: ").Append(Veld).Append("\n");
