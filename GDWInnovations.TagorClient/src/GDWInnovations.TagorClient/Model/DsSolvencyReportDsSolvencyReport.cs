...
{
    /// <summary>
    /// DsSolvencyReportDsSolvencyReport
    /// </summary>
    [DataContract(Name = "dsSolvencyReport_dsSolvencyReport")]
    public partial class DsSolvencyReportDsSolvencyReport : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsSolvencyReportDsSolvencyReport" /> class.
        /// </summary>
        /// <param name="ttSolvencyReport">ttSolvencyReport.</param>
        public DsSolvencyReportDsSolvencyReport(List<DsSolvencyReportDsSolvencyReportTtSolvencyReportInner> ttSolvencyReport = default(List<DsSolvencyReportDsSolvencyReportTtSolvencyReportInner>))
        {
            this.TtSolvencyReport = ttSolvencyReport;
        }

        /// <summary>
        /// Gets or Sets TtSolvencyReport
        /// </summary>
        [DataMember(Name = "ttSolvencyReport", EmitDefaultValue = false)]
        public List<DsSolvencyReportDsSolvencyReportTtSolvencyReportInner> TtSolvencyReport { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsSolvencyReportDsSolvencyReport {\n");
            sb.Append("  TtSolvencyReport: ").Append(TtSolvencyReport).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
