...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsTDOCWebDsTDOCWeb
    /// </summary>
    [DataContract(Name = "dsTDOCWeb_dsTDOCWeb")]
    public partial class DsTDOCWebDsTDOCWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOCWebDsTDOCWeb" /> class.
        /// </summary>
        /// <param name="ttTDOCWeb">ttTDOCWeb.</param>
        public DsTDOCWebDsTDOCWeb(List<DsTDOCWebDsTDOCWebTtTDOCWebInner> ttTDOCWeb = default(List<DsTDOCWebDsTDOCWebTtTDOCWebInner>))
        {
            this.TtTDOCWeb = ttTDOCWeb;
        }

        /// <summary>
        /// Gets or Sets TtTDOCWeb
        /// </summary>
        [DataMember(Name = "ttTDOCWeb", EmitDefaultValue = false)]
        public List<DsTDOCWebDsTDOCWebTtTDOCWebInner> TtTDOCWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOCWebDsTDOCWeb {\n");
            sb.Append("  TtTDOCWeb: ").Append(TtTDOCWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
