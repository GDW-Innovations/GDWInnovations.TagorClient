...
{
    /// <summary>
    /// ActionsSendSmsRequest
    /// </summary>
    [DataContract(Name = "ActionsSendSms_request")]
    public partial class ActionsSendSmsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionsSendSmsRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public ActionsSendSmsRequest(ActionsSendSmsRequestRequest request = default(ActionsSendSmsRequestRequest))
        {
        ...
        public ActionsSendSmsRequestRequest Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionsSendSmsRequest {\n");
