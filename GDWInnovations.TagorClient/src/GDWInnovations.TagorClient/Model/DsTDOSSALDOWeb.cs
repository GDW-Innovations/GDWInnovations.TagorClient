...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsTDOSSALDOWeb
    /// </summary>
    [DataContract(Name = "dsTDOSSALDOWeb")]
    public partial class DsTDOSSALDOWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSSALDOWeb" /> class.
        /// </summary>
        /// <param name="varDsTDOSSALDOWeb">varDsTDOSSALDOWeb.</param>
        public DsTDOSSALDOWeb(DsTDOSSALDOWebDsTDOSSALDOWeb varDsTDOSSALDOWeb = default(DsTDOSSALDOWebDsTDOSSALDOWeb))
        {
            this.VarDsTDOSSALDOWeb = varDsTDOSSALDOWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTDOSSALDOWeb
        /// </summary>
        [DataMember(Name = "dsTDOSSALDOWeb", EmitDefaultValue = false)]
        public DsTDOSSALDOWebDsTDOSSALDOWeb VarDsTDOSSALDOWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSSALDOWeb {\n");
            sb.Append("  VarDsTDOSSALDOWeb: ").Append(VarDsTDOSSALDOWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
