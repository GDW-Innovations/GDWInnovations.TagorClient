...
{
    /// <summary>
    /// UserAddRequestRequest
    /// </summary>
    [DataContract(Name = "UserAdd_request_request")]
    public partial class UserAddRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAddRequestRequest" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTUSERWeb">dsTUSERWeb.</param>
        public UserAddRequestRequest(DsWebContext dsWebContext = default(DsWebContext), DsTUSERWeb dsTUSERWeb = default(DsTUSERWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTUSERWeb = dsTUSERWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTUSERWeb
        /// </summary>
        [DataMember(Name = "dsTUSERWeb", EmitDefaultValue = false)]
        public DsTUSERWeb DsTUSERWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserAddRequestRequest {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTUSERWeb: ").Append(DsTUSERWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
