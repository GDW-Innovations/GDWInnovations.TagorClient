...
{
    /// <summary>
    /// DossierSearch200ResponseResponse
    /// </summary>
    [DataContract(Name = "DossierSearch_200_response_response")]
    public partial class DossierSearch200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierSearch200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTDOSSearch">dsTDOSSearch.</param>
        public DossierSearch200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTDOSSearch dsTDOSSearch = default(DsTDOSSearch))
        {
            this.DsWebContext = dsWebContext;
            this.DsTDOSSearch = dsTDOSSearch;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTDOSSearch
        /// </summary>
        [DataMember(Name = "dsTDOSSearch", EmitDefaultValue = false)]
        public DsTDOSSearch DsTDOSSearch { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierSearch200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTDOSSearch: ").Append(DsTDOSSearch).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
