...
{
    /// <summary>
    /// DsTPARADWebDsTPARADWeb
    /// </summary>
    [DataContract(Name = "dsTPARADWeb_dsTPARADWeb")]
    public partial class DsTPARADWebDsTPARADWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTPARADWebDsTPARADWeb" /> class.
        /// </summary>
        /// <param name="ttTPARADWeb">ttTPARADWeb.</param>
        public DsTPARADWebDsTPARADWeb(List<DsTPARADWebDsTPARADWebTtTPARADWebInner> ttTPARADWeb = default(List<DsTPARADWebDsTPARADWebTtTPARADWebInner>))
        {
            this.TtTPARADWeb = ttTPARADWeb;
        }

        /// <summary>
        /// Gets or Sets TtTPARADWeb
        /// </summary>
        [DataMember(Name = "ttTPARADWeb", EmitDefaultValue = false)]
        public List<DsTPARADWebDsTPARADWebTtTPARADWebInner> TtTPARADWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTPARADWebDsTPARADWeb {\n");
            sb.Append("  TtTPARADWeb: ").Append(TtTPARADWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
