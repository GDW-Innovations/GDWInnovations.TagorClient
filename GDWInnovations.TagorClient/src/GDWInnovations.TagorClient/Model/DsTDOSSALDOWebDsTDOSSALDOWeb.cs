...
{
    /// <summary>
    /// DsTDOSSALDOWebDsTDOSSALDOWeb
    /// </summary>
    [DataContract(Name = "dsTDOSSALDOWeb_dsTDOSSALDOWeb")]
    public partial class DsTDOSSALDOWebDsTDOSSALDOWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSSALDOWebDsTDOSSALDOWeb" /> class.
        /// </summary>
        /// <param name="ttTDOSSALDOWeb">ttTDOSSALDOWeb.</param>
        public DsTDOSSALDOWebDsTDOSSALDOWeb(List<DsTDOSSALDOWebDsTDOSSALDOWebTtTDOSSALDOWebInner> ttTDOSSALDOWeb = default(List<DsTDOSSALDOWebDsTDOSSALDOWebTtTDOSSALDOWebInner>))
        {
            this.TtTDOSSALDOWeb = ttTDOSSALDOWeb;
        }

        /// <summary>
        /// Gets or Sets TtTDOSSALDOWeb
        /// </summary>
        [DataMember(Name = "ttTDOSSALDOWeb", EmitDefaultValue = false)]
        public List<DsTDOSSALDOWebDsTDOSSALDOWebTtTDOSSALDOWebInner> TtTDOSSALDOWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSSALDOWebDsTDOSSALDOWeb {\n");
            sb.Append("  TtTDOSSALDOWeb: ").Append(TtTDOSSALDOWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
