...
{
    /// <summary>
    /// TagorServiceGetVoxtronVerwByHuisNr200ResponseResponse
    /// </summary>
    [DataContract(Name = "TagorServiceGetVoxtronVerwByHuisNr_200_response_response")]
    public partial class TagorServiceGetVoxtronVerwByHuisNr200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceGetVoxtronVerwByHuisNr200ResponseResponse" /> class.
        /// </summary>
        /// <param name="success">success.</param>
        /// <param name="error">error.</param>
        /// <param name="volgNrVerw">volgNrVerw.</param>
        /// <param name="returnCode">returnCode.</param>
        public TagorServiceGetVoxtronVerwByHuisNr200ResponseResponse(bool success = default(bool), string error = default(string), decimal volgNrVerw = default(decimal), string returnCode = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets VolgNrVerw
        /// </summary>
        [DataMember(Name = "VolgNrVerw", EmitDefaultValue = false)]
        public decimal VolgNrVerw { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceGetVoxtronVerwByHuisNr200ResponseResponse {\n");
