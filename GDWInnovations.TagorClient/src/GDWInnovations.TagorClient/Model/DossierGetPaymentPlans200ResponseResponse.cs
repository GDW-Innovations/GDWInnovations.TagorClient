...
{
    /// <summary>
    /// DossierGetPaymentPlans200ResponseResponse
    /// </summary>
    [DataContract(Name = "DossierGetPaymentPlans_200_response_response")]
    public partial class DossierGetPaymentPlans200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierGetPaymentPlans200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTDOSAFBDETWeb">dsTDOSAFBDETWeb.</param>
        public DossierGetPaymentPlans200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTDOSAFBDETWeb dsTDOSAFBDETWeb = default(DsTDOSAFBDETWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTDOSAFBDETWeb = dsTDOSAFBDETWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTDOSAFBDETWeb
        /// </summary>
        [DataMember(Name = "dsTDOSAFBDETWeb", EmitDefaultValue = false)]
        public DsTDOSAFBDETWeb DsTDOSAFBDETWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierGetPaymentPlans200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTDOSAFBDETWeb: ").Append(DsTDOSAFBDETWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
