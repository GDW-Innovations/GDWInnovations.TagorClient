...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// MessageAddRequest
    /// </summary>
    [DataContract(Name = "MessageAdd_request")]
    public partial class MessageAddRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageAddRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public MessageAddRequest(MessageAddRequestRequest request = default(MessageAddRequestRequest))
        {
        ...
        public MessageAddRequestRequest Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessageAddRequest {\n");
