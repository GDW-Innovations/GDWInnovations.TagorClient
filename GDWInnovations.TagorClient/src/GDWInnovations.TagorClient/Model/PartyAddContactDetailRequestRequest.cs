...
{
    /// <summary>
    /// PartyAddContactDetailRequestRequest
    /// </summary>
    [DataContract(Name = "PartyAddContactDetail_request_request")]
    public partial class PartyAddContactDetailRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartyAddContactDetailRequestRequest" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTCOMWeb">dsTCOMWeb.</param>
        public PartyAddContactDetailRequestRequest(DsWebContext dsWebContext = default(DsWebContext), DsTCOMWeb dsTCOMWeb = default(DsTCOMWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTCOMWeb = dsTCOMWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTCOMWeb
        /// </summary>
        [DataMember(Name = "dsTCOMWeb", EmitDefaultValue = false)]
        public DsTCOMWeb DsTCOMWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PartyAddContactDetailRequestRequest {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTCOMWeb: ").Append(DsTCOMWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
