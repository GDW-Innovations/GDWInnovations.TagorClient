...
{
    /// <summary>
    /// DossierCreateInfoLineRequest
    /// </summary>
    [DataContract(Name = "DossierCreateInfoLine_request")]
    public partial class DossierCreateInfoLineRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierCreateInfoLineRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public DossierCreateInfoLineRequest(DossierCreateInfoLineRequestRequest request = default(DossierCreateInfoLineRequestRequest))
        {
        ...
        public DossierCreateInfoLineRequestRequest Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierCreateInfoLineRequest {\n");
