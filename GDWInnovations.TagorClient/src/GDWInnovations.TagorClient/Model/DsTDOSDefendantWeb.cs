...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsTDOSDefendantWeb
    /// </summary>
    [DataContract(Name = "dsTDOSDefendantWeb")]
    public partial class DsTDOSDefendantWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSDefendantWeb" /> class.
        /// </summary>
        /// <param name="varDsTDOSDefendantWeb">varDsTDOSDefendantWeb.</param>
        public DsTDOSDefendantWeb(DsTDOSDefendantWebDsTDOSDefendantWeb varDsTDOSDefendantWeb = default(DsTDOSDefendantWebDsTDOSDefendantWeb))
        {
            this.VarDsTDOSDefendantWeb = varDsTDOSDefendantWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTDOSDefendantWeb
        /// </summary>
        [DataMember(Name = "dsTDOSDefendantWeb", EmitDefaultValue = false)]
        public DsTDOSDefendantWebDsTDOSDefendantWeb VarDsTDOSDefendantWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSDefendantWeb {\n");
            sb.Append("  VarDsTDOSDefendantWeb: ").Append(VarDsTDOSDefendantWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
