...
{
    /// <summary>
    /// TagorServiceKantoorOpenRequest
    /// </summary>
    [DataContract(Name = "TagorServiceKantoorOpen_request")]
    public partial class TagorServiceKantoorOpenRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceKantoorOpenRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public TagorServiceKantoorOpenRequest(TagorServiceKantoorOpenRequestRequest request = default(TagorServiceKantoorOpenRequestRequest))
        {
        ...
        public TagorServiceKantoorOpenRequestRequest Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceKantoorOpenRequest {\n");
