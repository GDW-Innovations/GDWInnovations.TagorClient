...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsConfigDsConfig
    /// </summary>
    [DataContract(Name = "dsConfig_dsConfig")]
    public partial class DsConfigDsConfig : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsConfigDsConfig" /> class.
        /// </summary>
        /// <param name="ttConfigWeb">ttConfigWeb.</param>
        public DsConfigDsConfig(List<DsConfigDsConfigTtConfigWebInner> ttConfigWeb = default(List<DsConfigDsConfigTtConfigWebInner>))
        {
        ...
        public List<DsConfigDsConfigTtConfigWebInner> TtConfigWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsConfigDsConfig {\n");
