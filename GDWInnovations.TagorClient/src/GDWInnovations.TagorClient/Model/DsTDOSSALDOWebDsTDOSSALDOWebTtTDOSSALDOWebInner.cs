...
{
    /// <summary>
    /// DsTDOSSALDOWebDsTDOSSALDOWebTtTDOSSALDOWebInner
    /// </summary>
    [DataContract(Name = "dsTDOSSALDOWeb_dsTDOSSALDOWeb_ttTDOSSALDOWeb_inner")]
    public partial class DsTDOSSALDOWebDsTDOSSALDOWebTtTDOSSALDOWebInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSSALDOWebDsTDOSSALDOWebTtTDOSSALDOWebInner" /> class.
        /// </summary>
        /// <param name="tQSALDOId">tQSALDOId.</param>
        /// <param name="bedrag">bedrag.</param>
        public DsTDOSSALDOWebDsTDOSSALDOWebTtTDOSSALDOWebInner(string tQSALDOId = default(string), string bedrag = default(string))
        {
            this.TQSALDOId = tQSALDOId;
            this.Bedrag = bedrag;
        }

        /// <summary>
        /// Gets or Sets TQSALDOId
        /// </summary>
        [DataMember(Name = "TQSALDO_Id", EmitDefaultValue = false)]
        public string TQSALDOId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSSALDOWebDsTDOSSALDOWebTtTDOSSALDOWebInner {\n");
            sb.Append("  TQSALDOId: ").Append(TQSALDOId).Append("\n");
