...
{
    /// <summary>
    /// PartyDeleteContactDetailRequest
    /// </summary>
    [DataContract(Name = "PartyDeleteContactDetail_request")]
    public partial class PartyDeleteContactDetailRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartyDeleteContactDetailRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public PartyDeleteContactDetailRequest(CodeGetListRequestRequest request = default(CodeGetListRequestRequest))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PartyDeleteContactDetailRequest {\n");
