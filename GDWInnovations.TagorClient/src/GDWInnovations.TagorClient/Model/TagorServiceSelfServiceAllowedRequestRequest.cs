...
{
    /// <summary>
    /// TagorServiceSelfServiceAllowedRequestRequest
    /// </summary>
    [DataContract(Name = "TagorServiceSelfServiceAllowed_request_request")]
    public partial class TagorServiceSelfServiceAllowedRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceSelfServiceAllowedRequestRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TagorServiceSelfServiceAllowedRequestRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceSelfServiceAllowedRequestRequest" /> class.
        /// </summary>
        ...
        /// <param name="config">Code of the config you want to validate against. Defaults to &#x60;DEF&#x60;..</param>
        /// <param name="telnr">If you pass a phone number here it will be saved on the defendant as &#x60;last contact&#x60;..</param>
        public TagorServiceSelfServiceAllowedRequestRequest(string tDOSId = default(string), string config = default(string), string telnr = default(string))
        {
            // to ensure "tDOSId" is required (not null)
            if (tDOSId == null)
            {
                throw new ArgumentNullException("tDOSId is a required property for TagorServiceSelfServiceAllowedRequestRequest and cannot be null");
            }
            this.TDOSId = tDOSId;
            this.Config = config;
            this.Telnr = telnr;
        ...
        /// <summary>
        /// Code of the config you want to validate against. Defaults to &#x60;DEF&#x60;.
        /// </summary>
        /// <value>Code of the config you want to validate against. Defaults to &#x60;DEF&#x60;.</value>
        [DataMember(Name = "Config", EmitDefaultValue = false)]
        public string Config { get; set; }

        /// <summary>
        /// If you pass a phone number here it will be saved on the defendant as &#x60;last contact&#x60;.
        /// </summary>
        /// <value>If you pass a phone number here it will be saved on the defendant as &#x60;last contact&#x60;.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceSelfServiceAllowedRequestRequest {\n");
