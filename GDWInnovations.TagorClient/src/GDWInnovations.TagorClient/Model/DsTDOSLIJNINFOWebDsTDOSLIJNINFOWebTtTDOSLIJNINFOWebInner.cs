...
{
    /// <summary>
    /// DsTDOSLIJNINFOWebDsTDOSLIJNINFOWebTtTDOSLIJNINFOWebInner
    /// </summary>
    [DataContract(Name = "dsTDOSLIJNINFOWeb_dsTDOSLIJNINFOWeb_ttTDOSLIJNINFOWeb_inner")]
    public partial class DsTDOSLIJNINFOWebDsTDOSLIJNINFOWebTtTDOSLIJNINFOWebInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSLIJNINFOWebDsTDOSLIJNINFOWebTtTDOSLIJNINFOWebInner" /> class.
        /// </summary>
        /// <param name="financialLineId">financialLineId.</param>
        /// <param name="typeId">A code id from the &#x60;TQINFO&#x60; table..</param>
        /// <param name="description">description.</param>
        /// <param name="date">date.</param>
        public DsTDOSLIJNINFOWebDsTDOSLIJNINFOWebTtTDOSLIJNINFOWebInner(string financialLineId = default(string), string typeId = default(string), string description = default(string), DateOnly date = default(DateOnly))
        {
            this.FinancialLineId = financialLineId;
            this.TypeId = typeId;
        ...
        /// <summary>
        /// Gets or Sets FinancialLineId
        /// </summary>
        [DataMember(Name = "financial_line_id", EmitDefaultValue = false)]
        public string FinancialLineId { get; set; }

        /// <summary>
        /// A code id from the &#x60;TQINFO&#x60; table.
        /// </summary>
        /// <value>A code id from the &#x60;TQINFO&#x60; table.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSLIJNINFOWebDsTDOSLIJNINFOWebTtTDOSLIJNINFOWebInner {\n");
            sb.Append("  FinancialLineId: ").Append(FinancialLineId).Append("\n");
