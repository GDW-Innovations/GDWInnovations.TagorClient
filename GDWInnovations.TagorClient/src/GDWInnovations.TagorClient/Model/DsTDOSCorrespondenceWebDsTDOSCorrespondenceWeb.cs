...
{
    /// <summary>
    /// DsTDOSCorrespondenceWebDsTDOSCorrespondenceWeb
    /// </summary>
    [DataContract(Name = "dsTDOSCorrespondenceWeb_dsTDOSCorrespondenceWeb")]
    public partial class DsTDOSCorrespondenceWebDsTDOSCorrespondenceWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSCorrespondenceWebDsTDOSCorrespondenceWeb" /> class.
        /// </summary>
        /// <param name="ttTDOSCorrespondenceWeb">ttTDOSCorrespondenceWeb.</param>
        public DsTDOSCorrespondenceWebDsTDOSCorrespondenceWeb(List<DsTDOSCorrespondenceWebDsTDOSCorrespondenceWebTtTDOSCorrespondenceWebInner> ttTDOSCorrespondenceWeb = default(List<DsTDOSCorrespondenceWebDsTDOSCorrespondenceWebTtTDOSCorrespondenceWebInner>))
        {
            this.TtTDOSCorrespondenceWeb = ttTDOSCorrespondenceWeb;
        }

        /// <summary>
        /// Gets or Sets TtTDOSCorrespondenceWeb
        /// </summary>
        [DataMember(Name = "ttTDOSCorrespondenceWeb", EmitDefaultValue = false)]
        public List<DsTDOSCorrespondenceWebDsTDOSCorrespondenceWebTtTDOSCorrespondenceWebInner> TtTDOSCorrespondenceWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSCorrespondenceWebDsTDOSCorrespondenceWeb {\n");
            sb.Append("  TtTDOSCorrespondenceWeb: ").Append(TtTDOSCorrespondenceWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
