...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsTDOSLIJNINFOWeb
    /// </summary>
    [DataContract(Name = "dsTDOSLIJNINFOWeb")]
    public partial class DsTDOSLIJNINFOWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSLIJNINFOWeb" /> class.
        /// </summary>
        /// <param name="varDsTDOSLIJNINFOWeb">varDsTDOSLIJNINFOWeb.</param>
        public DsTDOSLIJNINFOWeb(DsTDOSLIJNINFOWebDsTDOSLIJNINFOWeb varDsTDOSLIJNINFOWeb = default(DsTDOSLIJNINFOWebDsTDOSLIJNINFOWeb))
        {
            this.VarDsTDOSLIJNINFOWeb = varDsTDOSLIJNINFOWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTDOSLIJNINFOWeb
        /// </summary>
        [DataMember(Name = "dsTDOSLIJNINFOWeb", EmitDefaultValue = false)]
        public DsTDOSLIJNINFOWebDsTDOSLIJNINFOWeb VarDsTDOSLIJNINFOWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSLIJNINFOWeb {\n");
            sb.Append("  VarDsTDOSLIJNINFOWeb: ").Append(VarDsTDOSLIJNINFOWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
