...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// DsWebContext
    /// </summary>
    [DataContract(Name = "dsWebContext")]
    public partial class DsWebContext : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsWebContext" /> class.
        /// </summary>
        /// <param name="varDsWebContext">varDsWebContext.</param>
        public DsWebContext(DsWebContextDsWebContext varDsWebContext = default(DsWebContextDsWebContext))
        {
            this.VarDsWebContext = varDsWebContext;
        }

        /// <summary>
        /// Gets or Sets VarDsWebContext
        /// </summary>
        [DataMember(Name = "dsWebContext", EmitDefaultValue = false)]
        public DsWebContextDsWebContext VarDsWebContext { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsWebContext {\n");
            sb.Append("  VarDsWebContext: ").Append(VarDsWebContext).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
