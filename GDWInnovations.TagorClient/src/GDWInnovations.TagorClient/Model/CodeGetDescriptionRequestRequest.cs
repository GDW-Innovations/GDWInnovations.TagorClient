...
{
    /// <summary>
    /// CodeGetDescriptionRequestRequest
    /// </summary>
    [DataContract(Name = "CodeGetDescription_request_request")]
    public partial class CodeGetDescriptionRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CodeGetDescriptionRequestRequest" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsCodetabelIDs">dsCodetabelIDs.</param>
        public CodeGetDescriptionRequestRequest(DsWebContext dsWebContext = default(DsWebContext), DsCodetabelIDs dsCodetabelIDs = default(DsCodetabelIDs))
        {
        ...
        public DsCodetabelIDs DsCodetabelIDs { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CodeGetDescriptionRequestRequest {\n");
