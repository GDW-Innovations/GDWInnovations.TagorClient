...
{
    /// <summary>
    /// TagorServiceSendMailRequest
    /// </summary>
    [DataContract(Name = "TagorServiceSendMail_request")]
    public partial class TagorServiceSendMailRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceSendMailRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public TagorServiceSendMailRequest(TagorServiceSendMailRequestRequest request = default(TagorServiceSendMailRequestRequest))
        {
        ...
        public TagorServiceSendMailRequestRequest Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceSendMailRequest {\n");
