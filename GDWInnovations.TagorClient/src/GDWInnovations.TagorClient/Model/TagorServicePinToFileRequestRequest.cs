...
{
    /// <summary>
    /// TagorServicePinToFileRequestRequest
    /// </summary>
    [DataContract(Name = "TagorServicePinToFile_request_request")]
    public partial class TagorServicePinToFileRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServicePinToFileRequestRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TagorServicePinToFileRequestRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServicePinToFileRequestRequest" /> class.
        /// </summary>
        /// <param name="dossier">dossier (required).</param>
        /// <param name="pin">pin (required).</param>
        public TagorServicePinToFileRequestRequest(string dossier = default(string), string pin = default(string))
        {
            // to ensure "dossier" is required (not null)
            if (dossier == null)
            {
                throw new ArgumentNullException("dossier is a required property for TagorServicePinToFileRequestRequest and cannot be null");
            }
            this.Dossier = dossier;
            // to ensure "pin" is required (not null)
            if (pin == null)
            {
                throw new ArgumentNullException("pin is a required property for TagorServicePinToFileRequestRequest and cannot be null");
            }
            this.Pin = pin;
        }

        /// <summary>
        /// Gets or Sets Dossier
        /// </summary>
        [DataMember(Name = "Dossier", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServicePinToFileRequestRequest {\n");
            sb.Append("  Dossier: ").Append(Dossier).Append("\n");
