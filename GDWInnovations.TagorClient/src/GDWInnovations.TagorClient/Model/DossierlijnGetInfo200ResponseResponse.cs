...
{
    /// <summary>
    /// DossierlijnGetInfo200ResponseResponse
    /// </summary>
    [DataContract(Name = "DossierlijnGetInfo_200_response_response")]
    public partial class DossierlijnGetInfo200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierlijnGetInfo200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTDOSLIJNINFOWeb">dsTDOSLIJNINFOWeb.</param>
        public DossierlijnGetInfo200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTDOSLIJNINFOWeb dsTDOSLIJNINFOWeb = default(DsTDOSLIJNINFOWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTDOSLIJNINFOWeb = dsTDOSLIJNINFOWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTDOSLIJNINFOWeb
        /// </summary>
        [DataMember(Name = "dsTDOSLIJNINFOWeb", EmitDefaultValue = false)]
        public DsTDOSLIJNINFOWeb DsTDOSLIJNINFOWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierlijnGetInfo200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTDOSLIJNINFOWeb: ").Append(DsTDOSLIJNINFOWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
