...
namespace GDWInnovations.TagorClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SuccessErrorResponse")]
    public partial class SuccessErrorResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SuccessErrorResponse" /> class.
        /// </summary>
        /// <param name="success">success.</param>
        /// <param name="error">error.</param>
        public SuccessErrorResponse(bool success = default(bool), string error = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SuccessErrorResponse {\n");
