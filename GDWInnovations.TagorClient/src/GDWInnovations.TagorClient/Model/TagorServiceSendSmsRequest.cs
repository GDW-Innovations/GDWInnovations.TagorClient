...
{
    /// <summary>
    /// TagorServiceSendSmsRequest
    /// </summary>
    [DataContract(Name = "TagorServiceSendSms_request")]
    public partial class TagorServiceSendSmsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceSendSmsRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public TagorServiceSendSmsRequest(TagorServiceSendSmsRequestRequest request = default(TagorServiceSendSmsRequestRequest))
        {
        ...
        public TagorServiceSendSmsRequestRequest Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceSendSmsRequest {\n");
