...
{
    /// <summary>
    /// DossierGetLines200ResponseResponse
    /// </summary>
    [DataContract(Name = "DossierGetLines_200_response_response")]
    public partial class DossierGetLines200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierGetLines200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTDOSLIJNWeb">dsTDOSLIJNWeb.</param>
        public DossierGetLines200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTDOSLIJNWeb dsTDOSLIJNWeb = default(DsTDOSLIJNWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTDOSLIJNWeb = dsTDOSLIJNWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTDOSLIJNWeb
        /// </summary>
        [DataMember(Name = "dsTDOSLIJNWeb", EmitDefaultValue = false)]
        public DsTDOSLIJNWeb DsTDOSLIJNWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierGetLines200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTDOSLIJNWeb: ").Append(DsTDOSLIJNWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
