...
{
    /// <summary>
    /// TagorServiceKantoorOpen200ResponseResponse
    /// </summary>
    [DataContract(Name = "TagorServiceKantoorOpen_200_response_response")]
    public partial class TagorServiceKantoorOpen200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceKantoorOpen200ResponseResponse" /> class.
        /// </summary>
        /// <param name="success">success.</param>
        /// <param name="error">error.</param>
        /// <param name="kantoorOpen">kantoorOpen.</param>
        public TagorServiceKantoorOpen200ResponseResponse(bool success = default(bool), string error = default(string), bool kantoorOpen = default(bool))
        {
            this.Success = success;
            this.Error = error;
            this.KantoorOpen = kantoorOpen;
        }
        ...
        /// <summary>
        /// Gets or Sets KantoorOpen
        /// </summary>
        [DataMember(Name = "KantoorOpen", EmitDefaultValue = true)]
        public bool KantoorOpen { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceKantoorOpen200ResponseResponse {\n");
            sb.Append("  Success: ").Append(Success).Append("\n");
            sb.Append("  Error: ").Append(Error).Append("\n");
            sb.Append("  KantoorOpen: ").Append(KantoorOpen).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
