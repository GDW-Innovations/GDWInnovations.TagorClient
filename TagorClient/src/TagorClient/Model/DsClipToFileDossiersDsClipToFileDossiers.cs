...
{
    /// <summary>
    /// DsClipToFileDossiersDsClipToFileDossiers
    /// </summary>
    [DataContract(Name = "dsClipToFileDossiers_dsClipToFileDossiers")]
    public partial class DsClipToFileDossiersDsClipToFileDossiers : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsClipToFileDossiersDsClipToFileDossiers" /> class.
        /// </summary>
        /// <param name="ttClipToFileDossiers">ttClipToFileDossiers.</param>
        public DsClipToFileDossiersDsClipToFileDossiers(List<DsClipToFileDossiersDsClipToFileDossiersTtClipToFileDossiersInner> ttClipToFileDossiers = default(List<DsClipToFileDossiersDsClipToFileDossiersTtClipToFileDossiersInner>))
        {
            this.TtClipToFileDossiers = ttClipToFileDossiers;
        }

        /// <summary>
        /// Gets or Sets TtClipToFileDossiers
        /// </summary>
        [DataMember(Name = "ttClipToFileDossiers", EmitDefaultValue = false)]
        public List<DsClipToFileDossiersDsClipToFileDossiersTtClipToFileDossiersInner> TtClipToFileDossiers { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsClipToFileDossiersDsClipToFileDossiers {\n");
            sb.Append("  TtClipToFileDossiers: ").Append(TtClipToFileDossiers).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
