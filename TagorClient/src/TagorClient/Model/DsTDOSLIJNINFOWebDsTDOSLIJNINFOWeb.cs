...
{
    /// <summary>
    /// DsTDOSLIJNINFOWebDsTDOSLIJNINFOWeb
    /// </summary>
    [DataContract(Name = "dsTDOSLIJNINFOWeb_dsTDOSLIJNINFOWeb")]
    public partial class DsTDOSLIJNINFOWebDsTDOSLIJNINFOWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSLIJNINFOWebDsTDOSLIJNINFOWeb" /> class.
        /// </summary>
        /// <param name="ttTDOSLIJNINFOWeb">ttTDOSLIJNINFOWeb.</param>
        public DsTDOSLIJNINFOWebDsTDOSLIJNINFOWeb(List<DsTDOSLIJNINFOWebDsTDOSLIJNINFOWebTtTDOSLIJNINFOWebInner> ttTDOSLIJNINFOWeb = default(List<DsTDOSLIJNINFOWebDsTDOSLIJNINFOWebTtTDOSLIJNINFOWebInner>))
        {
            this.TtTDOSLIJNINFOWeb = ttTDOSLIJNINFOWeb;
        }

        /// <summary>
        /// Gets or Sets TtTDOSLIJNINFOWeb
        /// </summary>
        [DataMember(Name = "ttTDOSLIJNINFOWeb", EmitDefaultValue = false)]
        public List<DsTDOSLIJNINFOWebDsTDOSLIJNINFOWebTtTDOSLIJNINFOWebInner> TtTDOSLIJNINFOWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSLIJNINFOWebDsTDOSLIJNINFOWeb {\n");
            sb.Append("  TtTDOSLIJNINFOWeb: ").Append(TtTDOSLIJNINFOWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
