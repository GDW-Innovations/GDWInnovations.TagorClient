...
{
    /// <summary>
    /// DsWebContextDsWebContext
    /// </summary>
    [DataContract(Name = "dsWebContext_dsWebContext")]
    public partial class DsWebContextDsWebContext : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsWebContextDsWebContext" /> class.
        /// </summary>
        /// <param name="ttWebContext">ttWebContext.</param>
        public DsWebContextDsWebContext(List<DsWebContextDsWebContextTtWebContextInner> ttWebContext = default(List<DsWebContextDsWebContextTtWebContextInner>))
        {
        ...
        public List<DsWebContextDsWebContextTtWebContextInner> TtWebContext { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsWebContextDsWebContext {\n");
