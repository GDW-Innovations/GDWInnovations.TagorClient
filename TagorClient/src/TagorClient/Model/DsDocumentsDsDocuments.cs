...
{
    /// <summary>
    /// DsDocumentsDsDocuments
    /// </summary>
    [DataContract(Name = "dsDocuments_dsDocuments")]
    public partial class DsDocumentsDsDocuments : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsDocumentsDsDocuments" /> class.
        /// </summary>
        /// <param name="ttDocuments">ttDocuments.</param>
        public DsDocumentsDsDocuments(List<DsDocumentsDsDocumentsTtDocumentsInner> ttDocuments = default(List<DsDocumentsDsDocumentsTtDocumentsInner>))
        {
            this.TtDocuments = ttDocuments;
        }

        /// <summary>
        /// Gets or Sets TtDocuments
        /// </summary>
        [DataMember(Name = "ttDocuments", EmitDefaultValue = false)]
        public List<DsDocumentsDsDocumentsTtDocumentsInner> TtDocuments { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsDocumentsDsDocuments {\n");
            sb.Append("  TtDocuments: ").Append(TtDocuments).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
