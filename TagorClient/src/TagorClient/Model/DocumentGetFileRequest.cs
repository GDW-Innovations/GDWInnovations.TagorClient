...
{
    /// <summary>
    /// DocumentGetFileRequest
    /// </summary>
    [DataContract(Name = "DocumentGetFile_request")]
    public partial class DocumentGetFileRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentGetFileRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public DocumentGetFileRequest(CodeGetListRequestRequest request = default(CodeGetListRequestRequest))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentGetFileRequest {\n");
