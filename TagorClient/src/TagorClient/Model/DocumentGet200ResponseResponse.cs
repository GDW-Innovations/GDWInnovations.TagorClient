...
{
    /// <summary>
    /// DocumentGet200ResponseResponse
    /// </summary>
    [DataContract(Name = "DocumentGet_200_response_response")]
    public partial class DocumentGet200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentGet200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTDOCWeb">dsTDOCWeb.</param>
        public DocumentGet200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTDOCWeb dsTDOCWeb = default(DsTDOCWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTDOCWeb = dsTDOCWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTDOCWeb
        /// </summary>
        [DataMember(Name = "dsTDOCWeb", EmitDefaultValue = false)]
        public DsTDOCWeb DsTDOCWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentGet200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTDOCWeb: ").Append(DsTDOCWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
