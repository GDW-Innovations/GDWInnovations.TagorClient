...
{
    /// <summary>
    /// DsTBERICHTWebDsTBERICHTWeb
    /// </summary>
    [DataContract(Name = "dsTBERICHTWeb_dsTBERICHTWeb")]
    public partial class DsTBERICHTWebDsTBERICHTWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTBERICHTWebDsTBERICHTWeb" /> class.
        /// </summary>
        /// <param name="ttTBERICHTWeb">ttTBERICHTWeb.</param>
        public DsTBERICHTWebDsTBERICHTWeb(List<DsTBERICHTWebDsTBERICHTWebTtTBERICHTWebInner> ttTBERICHTWeb = default(List<DsTBERICHTWebDsTBERICHTWebTtTBERICHTWebInner>))
        {
            this.TtTBERICHTWeb = ttTBERICHTWeb;
        }

        /// <summary>
        /// Gets or Sets TtTBERICHTWeb
        /// </summary>
        [DataMember(Name = "ttTBERICHTWeb", EmitDefaultValue = false)]
        public List<DsTBERICHTWebDsTBERICHTWebTtTBERICHTWebInner> TtTBERICHTWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTBERICHTWebDsTBERICHTWeb {\n");
            sb.Append("  TtTBERICHTWeb: ").Append(TtTBERICHTWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
