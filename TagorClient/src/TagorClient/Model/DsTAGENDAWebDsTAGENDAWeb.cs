...
{
    /// <summary>
    /// DsTAGENDAWebDsTAGENDAWeb
    /// </summary>
    [DataContract(Name = "dsTAGENDAWeb_dsTAGENDAWeb")]
    public partial class DsTAGENDAWebDsTAGENDAWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTAGENDAWebDsTAGENDAWeb" /> class.
        /// </summary>
        /// <param name="ttTAGENDAWeb">ttTAGENDAWeb.</param>
        public DsTAGENDAWebDsTAGENDAWeb(List<DsTAGENDAWebDsTAGENDAWebTtTAGENDAWebInner> ttTAGENDAWeb = default(List<DsTAGENDAWebDsTAGENDAWebTtTAGENDAWebInner>))
        {
            this.TtTAGENDAWeb = ttTAGENDAWeb;
        }

        /// <summary>
        /// Gets or Sets TtTAGENDAWeb
        /// </summary>
        [DataMember(Name = "ttTAGENDAWeb", EmitDefaultValue = false)]
        public List<DsTAGENDAWebDsTAGENDAWebTtTAGENDAWebInner> TtTAGENDAWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTAGENDAWebDsTAGENDAWeb {\n");
            sb.Append("  TtTAGENDAWeb: ").Append(TtTAGENDAWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
