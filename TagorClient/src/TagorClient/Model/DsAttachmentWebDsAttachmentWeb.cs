...
{
    /// <summary>
    /// DsAttachmentWebDsAttachmentWeb
    /// </summary>
    [DataContract(Name = "dsAttachmentWeb_dsAttachmentWeb")]
    public partial class DsAttachmentWebDsAttachmentWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsAttachmentWebDsAttachmentWeb" /> class.
        /// </summary>
        /// <param name="ttAttachmentWeb">ttAttachmentWeb.</param>
        public DsAttachmentWebDsAttachmentWeb(List<DsAttachmentWebDsAttachmentWebTtAttachmentWebInner> ttAttachmentWeb = default(List<DsAttachmentWebDsAttachmentWebTtAttachmentWebInner>))
        {
            this.TtAttachmentWeb = ttAttachmentWeb;
        }

        /// <summary>
        /// Gets or Sets TtAttachmentWeb
        /// </summary>
        [DataMember(Name = "ttAttachmentWeb", EmitDefaultValue = false)]
        public List<DsAttachmentWebDsAttachmentWebTtAttachmentWebInner> TtAttachmentWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsAttachmentWebDsAttachmentWeb {\n");
            sb.Append("  TtAttachmentWeb: ").Append(TtAttachmentWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
