...
{
    /// <summary>
    /// DsCodetabelIDsDsCodetabelIDs
    /// </summary>
    [DataContract(Name = "dsCodetabelIDs_dsCodetabelIDs")]
    public partial class DsCodetabelIDsDsCodetabelIDs : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsCodetabelIDsDsCodetabelIDs" /> class.
        /// </summary>
        /// <param name="ttCodetabelIDs">ttCodetabelIDs.</param>
        public DsCodetabelIDsDsCodetabelIDs(List<DsCodetabelIDsDsCodetabelIDsTtCodetabelIDsInner> ttCodetabelIDs = default(List<DsCodetabelIDsDsCodetabelIDsTtCodetabelIDsInner>))
        {
            this.TtCodetabelIDs = ttCodetabelIDs;
        }

        /// <summary>
        /// Gets or Sets TtCodetabelIDs
        /// </summary>
        [DataMember(Name = "ttCodetabelIDs", EmitDefaultValue = false)]
        public List<DsCodetabelIDsDsCodetabelIDsTtCodetabelIDsInner> TtCodetabelIDs { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsCodetabelIDsDsCodetabelIDs {\n");
            sb.Append("  TtCodetabelIDs: ").Append(TtCodetabelIDs).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
