...
namespace TagorClient.Model
{
    ...
    /// DsTDOSSearch
    /// </summary>
    [DataContract(Name = "dsTDOSSearch")]
    public partial class DsTDOSSearch : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSSearch" /> class.
        /// </summary>
        /// <param name="varDsTDOSSearch">varDsTDOSSearch.</param>
        public DsTDOSSearch(DsTDOSSearchDsTDOSSearch varDsTDOSSearch = default(DsTDOSSearchDsTDOSSearch))
        {
            this.VarDsTDOSSearch = varDsTDOSSearch;
        }

        /// <summary>
        /// Gets or Sets VarDsTDOSSearch
        /// </summary>
        [DataMember(Name = "dsTDOSSearch", EmitDefaultValue = false)]
        public DsTDOSSearchDsTDOSSearch VarDsTDOSSearch { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSSearch {\n");
            sb.Append("  VarDsTDOSSearch: ").Append(VarDsTDOSSearch).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
