...
{
    /// <summary>
    /// DsTDOSSearchDsTDOSSearch
    /// </summary>
    [DataContract(Name = "dsTDOSSearch_dsTDOSSearch")]
    public partial class DsTDOSSearchDsTDOSSearch : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSSearchDsTDOSSearch" /> class.
        /// </summary>
        /// <param name="ttTDOSSearch">ttTDOSSearch.</param>
        public DsTDOSSearchDsTDOSSearch(List<DsTDOSSearchDsTDOSSearchTtTDOSSearchInner> ttTDOSSearch = default(List<DsTDOSSearchDsTDOSSearchTtTDOSSearchInner>))
        {
            this.TtTDOSSearch = ttTDOSSearch;
        }

        /// <summary>
        /// Gets or Sets TtTDOSSearch
        /// </summary>
        [DataMember(Name = "ttTDOSSearch", EmitDefaultValue = false)]
        public List<DsTDOSSearchDsTDOSSearchTtTDOSSearchInner> TtTDOSSearch { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSSearchDsTDOSSearch {\n");
            sb.Append("  TtTDOSSearch: ").Append(TtTDOSSearch).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
