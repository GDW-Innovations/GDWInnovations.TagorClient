...
namespace TagorClient.Model
{
    ...
    /// DsCodeWebDsCodeWeb
    /// </summary>
    [DataContract(Name = "dsCodeWeb_dsCodeWeb")]
    public partial class DsCodeWebDsCodeWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsCodeWebDsCodeWeb" /> class.
        /// </summary>
        /// <param name="ttCodeWeb">ttCodeWeb.</param>
        public DsCodeWebDsCodeWeb(List<DsCodeWebDsCodeWebTtCodeWebInner> ttCodeWeb = default(List<DsCodeWebDsCodeWebTtCodeWebInner>))
        {
            this.TtCodeWeb = ttCodeWeb;
        }

        /// <summary>
        /// Gets or Sets TtCodeWeb
        /// </summary>
        [DataMember(Name = "ttCodeWeb", EmitDefaultValue = false)]
        public List<DsCodeWebDsCodeWebTtCodeWebInner> TtCodeWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsCodeWebDsCodeWeb {\n");
            sb.Append("  TtCodeWeb: ").Append(TtCodeWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
