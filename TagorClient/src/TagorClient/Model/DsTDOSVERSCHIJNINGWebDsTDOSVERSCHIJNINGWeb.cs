...
{
    /// <summary>
    /// DsTDOSVERSCHIJNINGWebDsTDOSVERSCHIJNINGWeb
    /// </summary>
    [DataContract(Name = "dsTDOSVERSCHIJNINGWeb_dsTDOSVERSCHIJNINGWeb")]
    public partial class DsTDOSVERSCHIJNINGWebDsTDOSVERSCHIJNINGWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSVERSCHIJNINGWebDsTDOSVERSCHIJNINGWeb" /> class.
        /// </summary>
        /// <param name="ttTDOSVERSCHIJNINGWeb">ttTDOSVERSCHIJNINGWeb.</param>
        public DsTDOSVERSCHIJNINGWebDsTDOSVERSCHIJNINGWeb(List<DsTDOSVERSCHIJNINGWebDsTDOSVERSCHIJNINGWebTtTDOSVERSCHIJNINGWebInner> ttTDOSVERSCHIJNINGWeb = default(List<DsTDOSVERSCHIJNINGWebDsTDOSVERSCHIJNINGWebTtTDOSVERSCHIJNINGWebInner>))
        {
            this.TtTDOSVERSCHIJNINGWeb = ttTDOSVERSCHIJNINGWeb;
        }

        /// <summary>
        /// Gets or Sets TtTDOSVERSCHIJNINGWeb
        /// </summary>
        [DataMember(Name = "ttTDOSVERSCHIJNINGWeb", EmitDefaultValue = false)]
        public List<DsTDOSVERSCHIJNINGWebDsTDOSVERSCHIJNINGWebTtTDOSVERSCHIJNINGWebInner> TtTDOSVERSCHIJNINGWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSVERSCHIJNINGWebDsTDOSVERSCHIJNINGWeb {\n");
            sb.Append("  TtTDOSVERSCHIJNINGWeb: ").Append(TtTDOSVERSCHIJNINGWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
