...
{
    /// <summary>
    /// MessageGetMessage200ResponseResponse
    /// </summary>
    [DataContract(Name = "MessageGetMessage_200_response_response")]
    public partial class MessageGetMessage200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetMessage200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTBERICHTWeb">dsTBERICHTWeb.</param>
        public MessageGetMessage200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTBERICHTWeb dsTBERICHTWeb = default(DsTBERICHTWeb))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessageGetMessage200ResponseResponse {\n");
