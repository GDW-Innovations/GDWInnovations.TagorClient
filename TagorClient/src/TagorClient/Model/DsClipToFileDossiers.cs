...
namespace TagorClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dsClipToFileDossiers")]
    public partial class DsClipToFileDossiers : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsClipToFileDossiers" /> class.
        /// </summary>
        /// <param name="varDsClipToFileDossiers">varDsClipToFileDossiers.</param>
        public DsClipToFileDossiers(DsClipToFileDossiersDsClipToFileDossiers varDsClipToFileDossiers = default(DsClipToFileDossiersDsClipToFileDossiers))
        {
            this.VarDsClipToFileDossiers = varDsClipToFileDossiers;
        }

        /// <summary>
        /// Gets or Sets VarDsClipToFileDossiers
        /// </summary>
        [DataMember(Name = "dsClipToFileDossiers", EmitDefaultValue = false)]
        public DsClipToFileDossiersDsClipToFileDossiers VarDsClipToFileDossiers { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsClipToFileDossiers {\n");
            sb.Append("  VarDsClipToFileDossiers: ").Append(VarDsClipToFileDossiers).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
