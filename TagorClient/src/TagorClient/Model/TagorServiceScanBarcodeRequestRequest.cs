...
{
    /// <summary>
    /// TagorServiceScanBarcodeRequestRequest
    /// </summary>
    [DataContract(Name = "TagorServiceScanBarcode_request_request")]
    public partial class TagorServiceScanBarcodeRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceScanBarcodeRequestRequest" /> class.
        /// </summary>
        /// <param name="barcode">barcode.</param>
        public TagorServiceScanBarcodeRequestRequest(string barcode = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceScanBarcodeRequestRequest {\n");
