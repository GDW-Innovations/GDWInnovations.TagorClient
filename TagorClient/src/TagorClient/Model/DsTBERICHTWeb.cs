...
namespace TagorClient.Model
{
    ...
    /// DsTBERICHTWeb
    /// </summary>
    [DataContract(Name = "dsTBERICHTWeb")]
    public partial class DsTBERICHTWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTBERICHTWeb" /> class.
        /// </summary>
        /// <param name="varDsTBERICHTWeb">varDsTBERICHTWeb.</param>
        public DsTBERICHTWeb(DsTBERICHTWebDsTBERICHTWeb varDsTBERICHTWeb = default(DsTBERICHTWebDsTBERICHTWeb))
        {
            this.VarDsTBERICHTWeb = varDsTBERICHTWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTBERICHTWeb
        /// </summary>
        [DataMember(Name = "dsTBERICHTWeb", EmitDefaultValue = false)]
        public DsTBERICHTWebDsTBERICHTWeb VarDsTBERICHTWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTBERICHTWeb {\n");
            sb.Append("  VarDsTBERICHTWeb: ").Append(VarDsTBERICHTWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
