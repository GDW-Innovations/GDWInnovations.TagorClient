...
{
    /// <summary>
    /// DsTDOSTITELWebDsTDOSTITELWeb
    /// </summary>
    [DataContract(Name = "dsTDOSTITELWeb_dsTDOSTITELWeb")]
    public partial class DsTDOSTITELWebDsTDOSTITELWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSTITELWebDsTDOSTITELWeb" /> class.
        /// </summary>
        /// <param name="ttTDOSTITELWeb">ttTDOSTITELWeb.</param>
        public DsTDOSTITELWebDsTDOSTITELWeb(List<DsTDOSTITELWebDsTDOSTITELWebTtTDOSTITELWebInner> ttTDOSTITELWeb = default(List<DsTDOSTITELWebDsTDOSTITELWebTtTDOSTITELWebInner>))
        {
            this.TtTDOSTITELWeb = ttTDOSTITELWeb;
        }

        /// <summary>
        /// Gets or Sets TtTDOSTITELWeb
        /// </summary>
        [DataMember(Name = "ttTDOSTITELWeb", EmitDefaultValue = false)]
        public List<DsTDOSTITELWebDsTDOSTITELWebTtTDOSTITELWebInner> TtTDOSTITELWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSTITELWebDsTDOSTITELWeb {\n");
            sb.Append("  TtTDOSTITELWeb: ").Append(TtTDOSTITELWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
