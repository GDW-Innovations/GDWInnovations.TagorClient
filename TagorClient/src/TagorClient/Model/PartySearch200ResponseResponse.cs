...
{
    /// <summary>
    /// PartySearch200ResponseResponse
    /// </summary>
    [DataContract(Name = "PartySearch_200_response_response")]
    public partial class PartySearch200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartySearch200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTPARSearch">dsTPARSearch.</param>
        public PartySearch200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTPARSearch dsTPARSearch = default(DsTPARSearch))
        {
            this.DsWebContext = dsWebContext;
            this.DsTPARSearch = dsTPARSearch;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTPARSearch
        /// </summary>
        [DataMember(Name = "dsTPARSearch", EmitDefaultValue = false)]
        public DsTPARSearch DsTPARSearch { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PartySearch200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTPARSearch: ").Append(DsTPARSearch).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
