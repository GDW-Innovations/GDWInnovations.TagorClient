...
{
    /// <summary>
    /// DocumentGetMergefieldRequest
    /// </summary>
    [DataContract(Name = "DocumentGetMergefield_request")]
    public partial class DocumentGetMergefieldRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentGetMergefieldRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public DocumentGetMergefieldRequest(CodeGetListRequestRequest request = default(CodeGetListRequestRequest))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentGetMergefieldRequest {\n");
