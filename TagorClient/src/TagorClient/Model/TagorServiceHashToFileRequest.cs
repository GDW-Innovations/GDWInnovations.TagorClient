...
{
    /// <summary>
    /// TagorServiceHashToFileRequest
    /// </summary>
    [DataContract(Name = "TagorServiceHashToFile_request")]
    public partial class TagorServiceHashToFileRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceHashToFileRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public TagorServiceHashToFileRequest(TagorServiceHashToFileRequestRequest request = default(TagorServiceHashToFileRequestRequest))
        {
        ...
        public TagorServiceHashToFileRequestRequest Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceHashToFileRequest {\n");
