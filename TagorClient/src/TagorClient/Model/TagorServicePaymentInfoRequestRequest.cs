...
{
    /// <summary>
    /// TagorServicePaymentInfoRequestRequest
    /// </summary>
    [DataContract(Name = "TagorServicePaymentInfo_request_request")]
    public partial class TagorServicePaymentInfoRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServicePaymentInfoRequestRequest" /> class.
        /// </summary>
        /// <param name="tDOSId">Id of the file you want to check. This field is not required when using the &#x60;Code&#x60; authentication. In this case this endpoint will always only use the file linked to the code..</param>
        public TagorServicePaymentInfoRequestRequest(string tDOSId = default(string))
        {
            this.TDOSId = tDOSId;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServicePaymentInfoRequestRequest {\n");
