...
namespace TagorClient.Model
{
    ...
    /// DsTAGENDAWeb
    /// </summary>
    [DataContract(Name = "dsTAGENDAWeb")]
    public partial class DsTAGENDAWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTAGENDAWeb" /> class.
        /// </summary>
        /// <param name="varDsTAGENDAWeb">varDsTAGENDAWeb.</param>
        public DsTAGENDAWeb(DsTAGENDAWebDsTAGENDAWeb varDsTAGENDAWeb = default(DsTAGENDAWebDsTAGENDAWeb))
        {
            this.VarDsTAGENDAWeb = varDsTAGENDAWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTAGENDAWeb
        /// </summary>
        [DataMember(Name = "dsTAGENDAWeb", EmitDefaultValue = false)]
        public DsTAGENDAWebDsTAGENDAWeb VarDsTAGENDAWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTAGENDAWeb {\n");
            sb.Append("  VarDsTAGENDAWeb: ").Append(VarDsTAGENDAWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
