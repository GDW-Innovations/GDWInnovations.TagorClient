...
{
    /// <summary>
    /// TagorServiceGetVoxtronReferentieRequestRequest
    /// </summary>
    [DataContract(Name = "TagorServiceGetVoxtronReferentie_request_request")]
    public partial class TagorServiceGetVoxtronReferentieRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceGetVoxtronReferentieRequestRequest" /> class.
        /// </summary>
        /// <param name="referentie">File reference to search by. This field can include an index number to get a specific defendant when there is more than one active defendant on the file. The index number should be passed as: &#x60;{reference}|{index}&#x60;..</param>
        /// <param name="telnr">This number will added as communication number on the defendant if its a new number and there&#39;s only one defendant on the selected file..</param>
        public TagorServiceGetVoxtronReferentieRequestRequest(string referentie = default(string), string telnr = default(string))
        {
        ...
        /// <summary>
        /// File reference to search by. This field can include an index number to get a specific defendant when there is more than one active defendant on the file. The index number should be passed as: &#x60;{reference}|{index}&#x60;.
        /// </summary>
        /// <value>File reference to search by. This field can include an index number to get a specific defendant when there is more than one active defendant on the file. The index number should be passed as: &#x60;{reference}|{index}&#x60;.</value>
        [DataMember(Name = "Referentie", EmitDefaultValue = false)]
        public string Referentie { get; set; }

        /// <summary>
        /// This number will added as communication number on the defendant if its a new number and there&#39;s only one defendant on the selected file.
        /// </summary>
        /// <value>This number will added as communication number on the defendant if its a new number and there&#39;s only one defendant on the selected file.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceGetVoxtronReferentieRequestRequest {\n");
