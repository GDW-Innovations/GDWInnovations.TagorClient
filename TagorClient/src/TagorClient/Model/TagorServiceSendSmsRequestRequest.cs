...
{
    /// <summary>
    /// TagorServiceSendSmsRequestRequest
    /// </summary>
    [DataContract(Name = "TagorServiceSendSms_request_request")]
    public partial class TagorServiceSendSmsRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceSendSmsRequestRequest" /> class.
        /// </summary>
        /// <param name="tDOSId">tDOSId.</param>
        /// <param name="tPARId">tPARId.</param>
        /// <param name="telNr">telNr.</param>
        /// <param name="codeSms">codeSms.</param>
        public TagorServiceSendSmsRequestRequest(string tDOSId = default(string), string tPARId = default(string), string telNr = default(string), string codeSms = default(string))
        {
            this.TDOSId = tDOSId;
            this.TPARId = tPARId;
            this.TelNr = telNr;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceSendSmsRequestRequest {\n");
