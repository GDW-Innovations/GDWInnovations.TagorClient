...
{
    /// <summary>
    /// DsConfigDsConfigTtConfigWebInner
    /// </summary>
    [DataContract(Name = "dsConfig_dsConfig_ttConfigWeb_inner")]
    public partial class DsConfigDsConfigTtConfigWebInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsConfigDsConfigTtConfigWebInner" /> class.
        /// </summary>
        /// <param name="waarde">waarde.</param>
        /// <param name="tQCFGId">tQCFGId.</param>
        /// <param name="tQCFGCode">tQCFGCode.</param>
        public DsConfigDsConfigTtConfigWebInner(string waarde = default(string), string tQCFGId = default(string), string tQCFGCode = default(string))
        {
            this.Waarde = waarde;
            this.TQCFGId = tQCFGId;
            this.TQCFGCode = tQCFGCode;
        }
        ...
        /// <summary>
        /// Gets or Sets TQCFGId
        /// </summary>
        [DataMember(Name = "TQCFG_Id", EmitDefaultValue = false)]
        public string TQCFGId { get; set; }

        /// <summary>
        /// Gets or Sets TQCFGCode
        /// </summary>
        [DataMember(Name = "TQCFG_Code", EmitDefaultValue = false)]
        public string TQCFGCode { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsConfigDsConfigTtConfigWebInner {\n");
            sb.Append("  Waarde: ").Append(Waarde).Append("\n");
            sb.Append("  TQCFGId: ").Append(TQCFGId).Append("\n");
            sb.Append("  TQCFGCode: ").Append(TQCFGCode).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
