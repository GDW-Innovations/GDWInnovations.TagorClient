...
{
    /// <summary>
    /// DsTDOSAFBDETWebDsTDOSAFBDETWeb
    /// </summary>
    [DataContract(Name = "dsTDOSAFBDETWeb_dsTDOSAFBDETWeb")]
    public partial class DsTDOSAFBDETWebDsTDOSAFBDETWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSAFBDETWebDsTDOSAFBDETWeb" /> class.
        /// </summary>
        /// <param name="ttTDOSAFBDETWeb">ttTDOSAFBDETWeb.</param>
        public DsTDOSAFBDETWebDsTDOSAFBDETWeb(List<DsTDOSAFBDETWebDsTDOSAFBDETWebTtTDOSAFBDETWebInner> ttTDOSAFBDETWeb = default(List<DsTDOSAFBDETWebDsTDOSAFBDETWebTtTDOSAFBDETWebInner>))
        {
            this.TtTDOSAFBDETWeb = ttTDOSAFBDETWeb;
        }

        /// <summary>
        /// Gets or Sets TtTDOSAFBDETWeb
        /// </summary>
        [DataMember(Name = "ttTDOSAFBDETWeb", EmitDefaultValue = false)]
        public List<DsTDOSAFBDETWebDsTDOSAFBDETWebTtTDOSAFBDETWebInner> TtTDOSAFBDETWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSAFBDETWebDsTDOSAFBDETWeb {\n");
            sb.Append("  TtTDOSAFBDETWeb: ").Append(TtTDOSAFBDETWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
