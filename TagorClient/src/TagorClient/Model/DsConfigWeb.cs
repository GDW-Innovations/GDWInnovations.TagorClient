...
namespace TagorClient.Model
{
    ...
    /// DsConfigWeb
    /// </summary>
    [DataContract(Name = "dsConfigWeb")]
    public partial class DsConfigWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsConfigWeb" /> class.
        /// </summary>
        /// <param name="varDsConfigWeb">varDsConfigWeb.</param>
        public DsConfigWeb(DsConfigWebDsConfigWeb varDsConfigWeb = default(DsConfigWebDsConfigWeb))
        {
            this.VarDsConfigWeb = varDsConfigWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsConfigWeb
        /// </summary>
        [DataMember(Name = "dsConfigWeb", EmitDefaultValue = false)]
        public DsConfigWebDsConfigWeb VarDsConfigWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsConfigWeb {\n");
            sb.Append("  VarDsConfigWeb: ").Append(VarDsConfigWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
