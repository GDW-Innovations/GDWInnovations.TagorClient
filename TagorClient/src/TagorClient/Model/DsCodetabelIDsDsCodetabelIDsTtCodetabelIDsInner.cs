...
{
    /// <summary>
    /// DsCodetabelIDsDsCodetabelIDsTtCodetabelIDsInner
    /// </summary>
    [DataContract(Name = "dsCodetabelIDs_dsCodetabelIDs_ttCodetabelIDs_inner")]
    public partial class DsCodetabelIDsDsCodetabelIDsTtCodetabelIDsInner : IValidatableObject
    {
        /// <summary>
        /// Defines Taal
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DsCodetabelIDsDsCodetabelIDsTtCodetabelIDsInner" /> class.
        /// </summary>
        ...
        public DsCodetabelIDsDsCodetabelIDsTtCodetabelIDsInner(string tabel = default(string), string id = default(string), string code = default(string), TaalEnum? taal = default(TaalEnum?), string omschrijving = default(string))
        {
            this.Tabel = tabel;
            this.Id = id;
            this.Code = code;
        ...
        /// Gets or Sets Tabel
        /// </summary>
        [DataMember(Name = "Tabel", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsCodetabelIDsDsCodetabelIDsTtCodetabelIDsInner {\n");
            sb.Append("  Tabel: ").Append(Tabel).Append("\n");
