...
{
    /// <summary>
    /// ActionsSendMailRequest
    /// </summary>
    [DataContract(Name = "ActionsSendMail_request")]
    public partial class ActionsSendMailRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionsSendMailRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public ActionsSendMailRequest(ActionsSendMailRequestRequest request = default(ActionsSendMailRequestRequest))
        {
        ...
        public ActionsSendMailRequestRequest Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionsSendMailRequest {\n");
