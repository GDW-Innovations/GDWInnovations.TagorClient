...
{
    /// <summary>
    /// DsDocumentsDsDocumentsTtDocumentsInner
    /// </summary>
    [DataContract(Name = "dsDocuments_dsDocuments_ttDocuments_inner")]
    public partial class DsDocumentsDsDocumentsTtDocumentsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsDocumentsDsDocumentsTtDocumentsInner" /> class.
        /// </summary>
        /// <param name="tDOCMId">tDOCMId.</param>
        /// <param name="omschrijving">omschrijving.</param>
        /// <param name="id">id.</param>
        public DsDocumentsDsDocumentsTtDocumentsInner(string tDOCMId = default(string), string omschrijving = default(string), string id = default(string))
        {
            this.TDOCMId = tDOCMId;
            this.Omschrijving = omschrijving;
            this.Id = id;
        }

        /// <summary>
        /// Gets or Sets TDOCMId
        /// </summary>
        [DataMember(Name = "TDOCM_Id", EmitDefaultValue = false)]
        public string TDOCMId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsDocumentsDsDocumentsTtDocumentsInner {\n");
            sb.Append("  TDOCMId: ").Append(TDOCMId).Append("\n");
