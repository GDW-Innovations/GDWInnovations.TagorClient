...
{
    /// <summary>
    /// DsTUSERWebDsTUSERWeb
    /// </summary>
    [DataContract(Name = "dsTUSERWeb_dsTUSERWeb")]
    public partial class DsTUSERWebDsTUSERWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTUSERWebDsTUSERWeb" /> class.
        /// </summary>
        /// <param name="ttTUSERWeb">ttTUSERWeb.</param>
        public DsTUSERWebDsTUSERWeb(List<DsTUSERWebDsTUSERWebTtTUSERWebInner> ttTUSERWeb = default(List<DsTUSERWebDsTUSERWebTtTUSERWebInner>))
        {
            this.TtTUSERWeb = ttTUSERWeb;
        }

        /// <summary>
        /// Gets or Sets TtTUSERWeb
        /// </summary>
        [DataMember(Name = "ttTUSERWeb", EmitDefaultValue = false)]
        public List<DsTUSERWebDsTUSERWebTtTUSERWebInner> TtTUSERWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTUSERWebDsTUSERWeb {\n");
            sb.Append("  TtTUSERWeb: ").Append(TtTUSERWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
