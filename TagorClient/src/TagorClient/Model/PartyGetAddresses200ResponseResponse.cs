...
{
    /// <summary>
    /// PartyGetAddresses200ResponseResponse
    /// </summary>
    [DataContract(Name = "PartyGetAddresses_200_response_response")]
    public partial class PartyGetAddresses200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartyGetAddresses200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTPARADWeb">dsTPARADWeb.</param>
        public PartyGetAddresses200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTPARADWeb dsTPARADWeb = default(DsTPARADWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTPARADWeb = dsTPARADWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTPARADWeb
        /// </summary>
        [DataMember(Name = "dsTPARADWeb", EmitDefaultValue = false)]
        public DsTPARADWeb DsTPARADWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PartyGetAddresses200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTPARADWeb: ").Append(DsTPARADWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
