...
{
    /// <summary>
    /// TagorServiceKantoorOpenRequestRequest
    /// </summary>
    [DataContract(Name = "TagorServiceKantoorOpen_request_request")]
    public partial class TagorServiceKantoorOpenRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceKantoorOpenRequestRequest" /> class.
        /// </summary>
        /// <param name="tDOSId">tDOSId.</param>
        public TagorServiceKantoorOpenRequestRequest(string tDOSId = default(string))
        {
            this.TDOSId = tDOSId;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceKantoorOpenRequestRequest {\n");
