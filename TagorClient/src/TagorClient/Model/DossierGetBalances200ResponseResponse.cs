...
{
    /// <summary>
    /// DossierGetBalances200ResponseResponse
    /// </summary>
    [DataContract(Name = "DossierGetBalances_200_response_response")]
    public partial class DossierGetBalances200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierGetBalances200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTDOSSALDOWeb">dsTDOSSALDOWeb.</param>
        public DossierGetBalances200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTDOSSALDOWeb dsTDOSSALDOWeb = default(DsTDOSSALDOWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTDOSSALDOWeb = dsTDOSSALDOWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTDOSSALDOWeb
        /// </summary>
        [DataMember(Name = "dsTDOSSALDOWeb", EmitDefaultValue = false)]
        public DsTDOSSALDOWeb DsTDOSSALDOWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierGetBalances200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTDOSSALDOWeb: ").Append(DsTDOSSALDOWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
