...
{
    /// <summary>
    /// ConfigGetRequestableDocuments200ResponseResponse
    /// </summary>
    [DataContract(Name = "ConfigGetRequestableDocuments_200_response_response")]
    public partial class ConfigGetRequestableDocuments200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigGetRequestableDocuments200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsCodetabelIDs">dsCodetabelIDs.</param>
        public ConfigGetRequestableDocuments200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsDocuments dsCodetabelIDs = default(DsDocuments))
        {
            this.DsWebContext = dsWebContext;
            this.DsCodetabelIDs = dsCodetabelIDs;
        }
        ...
        /// <summary>
        /// Gets or Sets DsCodetabelIDs
        /// </summary>
        [DataMember(Name = "dsCodetabelIDs", EmitDefaultValue = false)]
        public DsDocuments DsCodetabelIDs { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConfigGetRequestableDocuments200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsCodetabelIDs: ").Append(DsCodetabelIDs).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
