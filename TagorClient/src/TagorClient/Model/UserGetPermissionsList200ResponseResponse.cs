...
{
    /// <summary>
    /// UserGetPermissionsList200ResponseResponse
    /// </summary>
    [DataContract(Name = "UserGetPermissionsList_200_response_response")]
    public partial class UserGetPermissionsList200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGetPermissionsList200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsCodeWeb">dsCodeWeb.</param>
        public UserGetPermissionsList200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsCodeWeb dsCodeWeb = default(DsCodeWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsCodeWeb = dsCodeWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsCodeWeb
        /// </summary>
        [DataMember(Name = "dsCodeWeb", EmitDefaultValue = false)]
        public DsCodeWeb DsCodeWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserGetPermissionsList200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsCodeWeb: ").Append(DsCodeWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
