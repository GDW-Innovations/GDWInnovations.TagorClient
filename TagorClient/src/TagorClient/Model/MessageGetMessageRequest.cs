...
namespace TagorClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MessageGetMessage_request")]
    public partial class MessageGetMessageRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetMessageRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public MessageGetMessageRequest(CodeGetListRequestRequest request = default(CodeGetListRequestRequest))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessageGetMessageRequest {\n");
