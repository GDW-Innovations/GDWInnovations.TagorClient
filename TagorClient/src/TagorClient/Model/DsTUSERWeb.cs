...
namespace TagorClient.Model
{
    ...
    /// DsTUSERWeb
    /// </summary>
    [DataContract(Name = "dsTUSERWeb")]
    public partial class DsTUSERWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTUSERWeb" /> class.
        /// </summary>
        /// <param name="varDsTUSERWeb">varDsTUSERWeb.</param>
        public DsTUSERWeb(DsTUSERWebDsTUSERWeb varDsTUSERWeb = default(DsTUSERWebDsTUSERWeb))
        {
            this.VarDsTUSERWeb = varDsTUSERWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTUSERWeb
        /// </summary>
        [DataMember(Name = "dsTUSERWeb", EmitDefaultValue = false)]
        public DsTUSERWebDsTUSERWeb VarDsTUSERWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTUSERWeb {\n");
            sb.Append("  VarDsTUSERWeb: ").Append(VarDsTUSERWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
