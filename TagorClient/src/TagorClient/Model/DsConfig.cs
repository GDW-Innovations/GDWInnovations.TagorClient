...
namespace TagorClient.Model
{
    ...
    /// DsConfig
    /// </summary>
    [DataContract(Name = "dsConfig")]
    public partial class DsConfig : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsConfig" /> class.
        /// </summary>
        /// <param name="varDsConfig">varDsConfig.</param>
        public DsConfig(DsConfigDsConfig varDsConfig = default(DsConfigDsConfig))
        {
            this.VarDsConfig = varDsConfig;
        }

        /// <summary>
        /// Gets or Sets VarDsConfig
        /// </summary>
        [DataMember(Name = "dsConfig", EmitDefaultValue = false)]
        public DsConfigDsConfig VarDsConfig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarDsConfig: ").Append(VarDsConfig).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
