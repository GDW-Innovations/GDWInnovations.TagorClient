...
{
    /// <summary>
    /// DossierCreateLineRequestRequest
    /// </summary>
    [DataContract(Name = "DossierCreateLine_request_request")]
    public partial class DossierCreateLineRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierCreateLineRequestRequest" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTDOSLIJNWeb">dsTDOSLIJNWeb.</param>
        public DossierCreateLineRequestRequest(DsWebContext dsWebContext = default(DsWebContext), DsTDOSLIJNWeb dsTDOSLIJNWeb = default(DsTDOSLIJNWeb))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierCreateLineRequestRequest {\n");
