...
{
    /// <summary>
    /// TagorServicePinToFile200ResponseResponse
    /// </summary>
    [DataContract(Name = "TagorServicePinToFile_200_response_response")]
    public partial class TagorServicePinToFile200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServicePinToFile200ResponseResponse" /> class.
        /// </summary>
        /// <param name="success">success.</param>
        /// <param name="error">error.</param>
        /// <param name="tDOSId">tDOSId.</param>
        /// <param name="tPARId">tPARId.</param>
        public TagorServicePinToFile200ResponseResponse(bool success = default(bool), string error = default(string), string tDOSId = default(string), string tPARId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServicePinToFile200ResponseResponse {\n");
