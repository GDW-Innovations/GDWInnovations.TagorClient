...
{
    /// <summary>
    /// DossierSearchRequestRequest
    /// </summary>
    [DataContract(Name = "DossierSearch_request_request")]
    public partial class DossierSearchRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierSearchRequestRequest" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsFilter">dsFilter.</param>
        public DossierSearchRequestRequest(DsWebContext dsWebContext = default(DsWebContext), DsFilter dsFilter = default(DsFilter))
        {
        ...
        /// <summary>
        /// Gets or Sets DsFilter
        /// </summary>
        [DataMember(Name = "dsFilter", EmitDefaultValue = false)]
        public DsFilter DsFilter { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierSearchRequestRequest {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsFilter: ").Append(DsFilter).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
