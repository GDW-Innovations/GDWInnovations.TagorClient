...
{
    /// <summary>
    /// TagorServicePaymentDetails200ResponseResponse
    /// </summary>
    [DataContract(Name = "TagorServicePaymentDetails_200_response_response")]
    public partial class TagorServicePaymentDetails200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServicePaymentDetails200ResponseResponse" /> class.
        /// </summary>
        /// <param name="success">success.</param>
        /// <param name="error">error.</param>
        /// <param name="data">data.</param>
        public TagorServicePaymentDetails200ResponseResponse(bool success = default(bool), string error = default(string), string data = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServicePaymentDetails200ResponseResponse {\n");
