...
{
    /// <summary>
    /// DossierGetAppearance200ResponseResponse
    /// </summary>
    [DataContract(Name = "DossierGetAppearance_200_response_response")]
    public partial class DossierGetAppearance200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierGetAppearance200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTDOSVERSCHIJNINGWeb">dsTDOSVERSCHIJNINGWeb.</param>
        public DossierGetAppearance200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTDOSVERSCHIJNINGWeb dsTDOSVERSCHIJNINGWeb = default(DsTDOSVERSCHIJNINGWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTDOSVERSCHIJNINGWeb = dsTDOSVERSCHIJNINGWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTDOSVERSCHIJNINGWeb
        /// </summary>
        [DataMember(Name = "dsTDOSVERSCHIJNINGWeb", EmitDefaultValue = false)]
        public DsTDOSVERSCHIJNINGWeb DsTDOSVERSCHIJNINGWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierGetAppearance200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTDOSVERSCHIJNINGWeb: ").Append(DsTDOSVERSCHIJNINGWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
