...
namespace TagorClient.Model
{
    ...
    /// DsTDOSINFOWeb
    /// </summary>
    [DataContract(Name = "dsTDOSINFOWeb")]
    public partial class DsTDOSINFOWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSINFOWeb" /> class.
        /// </summary>
        /// <param name="varDsTDOSINFOWeb">varDsTDOSINFOWeb.</param>
        public DsTDOSINFOWeb(DsTDOSINFOWebDsTDOSINFOWeb varDsTDOSINFOWeb = default(DsTDOSINFOWebDsTDOSINFOWeb))
        {
            this.VarDsTDOSINFOWeb = varDsTDOSINFOWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTDOSINFOWeb
        /// </summary>
        [DataMember(Name = "dsTDOSINFOWeb", EmitDefaultValue = false)]
        public DsTDOSINFOWebDsTDOSINFOWeb VarDsTDOSINFOWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSINFOWeb {\n");
            sb.Append("  VarDsTDOSINFOWeb: ").Append(VarDsTDOSINFOWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
