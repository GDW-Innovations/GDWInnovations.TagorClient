...
{
    /// <summary>
    /// TagorServiceHashToFile200ResponseResponse
    /// </summary>
    [DataContract(Name = "TagorServiceHashToFile_200_response_response")]
    public partial class TagorServiceHashToFile200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Defines Taal
        /// </summary>
        ...
        /// Gets or Sets Taal
        /// </summary>
        [DataMember(Name = "Taal", EmitDefaultValue = true)]
        public TaalEnum? Taal { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceHashToFile200ResponseResponse" /> class.
        /// </summary>
        ...
        /// <param name="geldigTot">geldigTot.</param>
        public TagorServiceHashToFile200ResponseResponse(bool success = default(bool), string error = default(string), string tDOSId = default(string), string tPARId = default(string), TaalEnum? taal = default(TaalEnum?), string geldigTot = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceHashToFile200ResponseResponse {\n");
