...
{
    /// <summary>
    /// TagorServiceSavePaymentPlan200ResponseResponse
    /// </summary>
    [DataContract(Name = "TagorServiceSavePaymentPlan_200_response_response")]
    public partial class TagorServiceSavePaymentPlan200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceSavePaymentPlan200ResponseResponse" /> class.
        /// </summary>
        /// <param name="success">success.</param>
        /// <param name="error">error.</param>
        /// <param name="periodes">periodes.</param>
        /// <param name="bedrag">bedrag.</param>
        public TagorServiceSavePaymentPlan200ResponseResponse(bool success = default(bool), string error = default(string), int periodes = default(int), double bedrag = default(double))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceSavePaymentPlan200ResponseResponse {\n");
