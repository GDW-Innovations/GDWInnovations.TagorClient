...
{
    /// <summary>
    /// ActionsSendMailRequestRequest
    /// </summary>
    [DataContract(Name = "ActionsSendMail_request_request")]
    public partial class ActionsSendMailRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionsSendMailRequestRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ActionsSendMailRequestRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionsSendMailRequestRequest" /> class.
        /// </summary>
        ...
        /// <param name="codeEmail">codeEmail (required).</param>
        public ActionsSendMailRequestRequest(string tDOSId = default(string), string tPARId = default(string), string emailadres = default(string), string codeEmail = default(string))
        {
            // to ensure "codeEmail" is required (not null)
            if (codeEmail == null)
            {
                throw new ArgumentNullException("codeEmail is a required property for ActionsSendMailRequestRequest and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "CodeEmail", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionsSendMailRequestRequest {\n");
