...
{
    /// <summary>
    /// DossierCreateLineRequest
    /// </summary>
    [DataContract(Name = "DossierCreateLine_request")]
    public partial class DossierCreateLineRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierCreateLineRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public DossierCreateLineRequest(DossierCreateLineRequestRequest request = default(DossierCreateLineRequestRequest))
        {
        ...
        public DossierCreateLineRequestRequest Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierCreateLineRequest {\n");
