...
namespace TagorClient.Model
{
    ...
    /// PayStartRequest
    /// </summary>
    [DataContract(Name = "PayStart_request")]
    public partial class PayStartRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayStartRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public PayStartRequest(PayStartRequestRequest request = default(PayStartRequestRequest))
        {
        ...
        public PayStartRequestRequest Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayStartRequest {\n");
