...
namespace TagorClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DossierCreateAgenda_request")]
    public partial class DossierCreateAgendaRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierCreateAgendaRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public DossierCreateAgendaRequest(DossierCreateAgendaRequestRequest request = default(DossierCreateAgendaRequestRequest))
        {
        ...
        public DossierCreateAgendaRequestRequest Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierCreateAgendaRequest {\n");
