...
{
    /// <summary>
    /// CodeGetDescriptionRequest
    /// </summary>
    [DataContract(Name = "CodeGetDescription_request")]
    public partial class CodeGetDescriptionRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CodeGetDescriptionRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public CodeGetDescriptionRequest(CodeGetDescriptionRequestRequest request = default(CodeGetDescriptionRequestRequest))
        {
        ...
        public CodeGetDescriptionRequestRequest Request { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CodeGetDescriptionRequest {\n");
