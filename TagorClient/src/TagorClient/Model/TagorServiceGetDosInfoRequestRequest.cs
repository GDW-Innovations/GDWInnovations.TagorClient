...
{
    /// <summary>
    /// TagorServiceGetDosInfoRequestRequest
    /// </summary>
    [DataContract(Name = "TagorServiceGetDosInfo_request_request")]
    public partial class TagorServiceGetDosInfoRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceGetDosInfoRequestRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TagorServiceGetDosInfoRequestRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TagorServiceGetDosInfoRequestRequest" /> class.
        /// </summary>
        /// <param name="tDOSId">Id of the file you want to retreive. This field is not required when using the &#x60;Code&#x60; authentication. In this case this endpoint will always only return the file linked to the code. (required).</param>
        /// <param name="tPARId">When this id is passed, the party this id represents is returned (if its a party on the file). This is useful when a file has multiple parties of the same type and you want to get a specific party instead of the first one in the list..</param>
        public TagorServiceGetDosInfoRequestRequest(string tDOSId = default(string), string tPARId = default(string))
        {
            // to ensure "tDOSId" is required (not null)
            if (tDOSId == null)
            {
                throw new ArgumentNullException("tDOSId is a required property for TagorServiceGetDosInfoRequestRequest and cannot be null");
            }
            this.TDOSId = tDOSId;
            this.TPARId = tPARId;
        }
        ...
        /// <summary>
        /// Id of the file you want to retreive. This field is not required when using the &#x60;Code&#x60; authentication. In this case this endpoint will always only return the file linked to the code.
        /// </summary>
        /// <value>Id of the file you want to retreive. This field is not required when using the &#x60;Code&#x60; authentication. In this case this endpoint will always only return the file linked to the code.</value>
        [DataMember(Name = "TDOS_Id", IsRequired = true, EmitDefaultValue = true)]
        public string TDOSId { get; set; }

        /// <summary>
        /// When this id is passed, the party this id represents is returned (if its a party on the file). This is useful when a file has multiple parties of the same type and you want to get a specific party instead of the first one in the list.
        /// </summary>
        /// <value>When this id is passed, the party this id represents is returned (if its a party on the file). This is useful when a file has multiple parties of the same type and you want to get a specific party instead of the first one in the list.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagorServiceGetDosInfoRequestRequest {\n");
