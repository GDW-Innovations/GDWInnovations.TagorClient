...
namespace TagorClient.Model
{
    ...
    /// UserAddRequest
    /// </summary>
    [DataContract(Name = "UserAdd_request")]
    public partial class UserAddRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAddRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public UserAddRequest(UserAddRequestRequest request = default(UserAddRequestRequest))
        {
        ...
        public UserAddRequestRequest Request { get; set; }
