...
namespace TagorClient.Model
{
    ...
    /// DsTPARADWeb
    /// </summary>
    [DataContract(Name = "dsTPARADWeb")]
    public partial class DsTPARADWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTPARADWeb" /> class.
        /// </summary>
        /// <param name="varDsTPARADWeb">varDsTPARADWeb.</param>
        public DsTPARADWeb(DsTPARADWebDsTPARADWeb varDsTPARADWeb = default(DsTPARADWebDsTPARADWeb))
        {
            this.VarDsTPARADWeb = varDsTPARADWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTPARADWeb
        /// </summary>
        [DataMember(Name = "dsTPARADWeb", EmitDefaultValue = false)]
        public DsTPARADWebDsTPARADWeb VarDsTPARADWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTPARADWeb {\n");
            sb.Append("  VarDsTPARADWeb: ").Append(VarDsTPARADWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
