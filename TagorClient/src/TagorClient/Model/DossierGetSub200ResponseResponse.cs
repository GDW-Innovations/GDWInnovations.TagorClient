...
{
    /// <summary>
    /// DossierGetSub200ResponseResponse
    /// </summary>
    [DataContract(Name = "DossierGetSub_200_response_response")]
    public partial class DossierGetSub200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierGetSub200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTDOSDOSWeb">dsTDOSDOSWeb.</param>
        public DossierGetSub200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTDOSDOSWeb dsTDOSDOSWeb = default(DsTDOSDOSWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTDOSDOSWeb = dsTDOSDOSWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTDOSDOSWeb
        /// </summary>
        [DataMember(Name = "dsTDOSDOSWeb", EmitDefaultValue = false)]
        public DsTDOSDOSWeb DsTDOSDOSWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierGetSub200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTDOSDOSWeb: ").Append(DsTDOSDOSWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
