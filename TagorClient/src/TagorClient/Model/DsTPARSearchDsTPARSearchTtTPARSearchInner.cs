...
{
    /// <summary>
    /// DsTPARSearchDsTPARSearchTtTPARSearchInner
    /// </summary>
    [DataContract(Name = "dsTPARSearch_dsTPARSearch_ttTPARSearch_inner")]
    public partial class DsTPARSearchDsTPARSearchTtTPARSearchInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTPARSearchDsTPARSearchTtTPARSearchInner" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="firstName">firstName.</param>
        /// <param name="lastName">lastName.</param>
        public DsTPARSearchDsTPARSearchTtTPARSearchInner(string id = default(string), string firstName = default(string), string lastName = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTPARSearchDsTPARSearchTtTPARSearchInner {\n");
