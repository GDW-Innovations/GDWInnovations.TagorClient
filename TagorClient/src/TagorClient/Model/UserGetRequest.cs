...
namespace TagorClient.Model
{
    ...
    /// UserGetRequest
    /// </summary>
    [DataContract(Name = "UserGet_request")]
    public partial class UserGetRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGetRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public UserGetRequest(UserGetRequestRequest request = default(UserGetRequestRequest))
        {
        ...
        public UserGetRequestRequest Request { get; set; }
