...
{
    /// <summary>
    /// UserGetRequestRequest
    /// </summary>
    [DataContract(Name = "UserGet_request_request")]
    public partial class UserGetRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGetRequestRequest" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        public UserGetRequestRequest(DsWebContext dsWebContext = default(DsWebContext))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserGetRequestRequest {\n");
