...
{
    /// <summary>
    /// MessageAddRequestRequest
    /// </summary>
    [DataContract(Name = "MessageAdd_request_request")]
    public partial class MessageAddRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageAddRequestRequest" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTBERICHTWeb">dsTBERICHTWeb.</param>
        /// <param name="dsAttachmentWeb">dsAttachmentWeb.</param>
        public MessageAddRequestRequest(DsWebContext dsWebContext = default(DsWebContext), DsTBERICHTWeb dsTBERICHTWeb = default(DsTBERICHTWeb), DsAttachmentWeb dsAttachmentWeb = default(DsAttachmentWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTBERICHTWeb = dsTBERICHTWeb;
            this.DsAttachmentWeb = dsAttachmentWeb;
        }

        /// <summary>
        /// Gets or Sets DsWebContext
        /// </summary>
        [DataMember(Name = "dsWebContext", EmitDefaultValue = false)]
        public DsWebContext DsWebContext { get; set; }

        /// <summary>
        /// Gets or Sets DsTBERICHTWeb
        /// </summary>
        [DataMember(Name = "dsTBERICHTWeb", EmitDefaultValue = false)]
        public DsTBERICHTWeb DsTBERICHTWeb { get; set; }

        /// <summary>
        /// Gets or Sets DsAttachmentWeb
        /// </summary>
        [DataMember(Name = "dsAttachmentWeb", EmitDefaultValue = false)]
        public DsAttachmentWeb DsAttachmentWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessageAddRequestRequest {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTBERICHTWeb: ").Append(DsTBERICHTWeb).Append("\n");
            sb.Append("  DsAttachmentWeb: ").Append(DsAttachmentWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
