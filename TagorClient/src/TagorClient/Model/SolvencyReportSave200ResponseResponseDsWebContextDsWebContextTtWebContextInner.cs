...
{
    /// <summary>
    /// SolvencyReportSave200ResponseResponseDsWebContextDsWebContextTtWebContextInner
    /// </summary>
    [DataContract(Name = "SolvencyReportSave_200_response_response_dsWebContext_dsWebContext_ttWebContext_inner")]
    public partial class SolvencyReportSave200ResponseResponseDsWebContextDsWebContextTtWebContextInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SolvencyReportSave200ResponseResponseDsWebContextDsWebContextTtWebContextInner" /> class.
        /// </summary>
        /// <param name="contextKey">contextKey.</param>
        /// <param name="contextValue">contextValue.</param>
        public SolvencyReportSave200ResponseResponseDsWebContextDsWebContextTtWebContextInner(string contextKey = default(string), string contextValue = default(string))
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SolvencyReportSave200ResponseResponseDsWebContextDsWebContextTtWebContextInner {\n");
