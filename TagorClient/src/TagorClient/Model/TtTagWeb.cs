...
namespace TagorClient.Model
{
    ...
    /// TtTagWeb
    /// </summary>
    [DataContract(Name = "ttTagWeb")]
    public partial class TtTagWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TtTagWeb" /> class.
        /// </summary>
        /// <param name="omschrijving">omschrijving.</param>
        /// <param name="tQTEMPLATEId">tQTEMPLATEId.</param>
        public TtTagWeb(string omschrijving = default(string), string tQTEMPLATEId = default(string))
        {
            this.Omschrijving = omschrijving;
            this.TQTEMPLATEId = tQTEMPLATEId;
        }
        ...
        /// <summary>
        /// Gets or Sets TQTEMPLATEId
        /// </summary>
        [DataMember(Name = "TQTEMPLATE_Id", EmitDefaultValue = false)]
        public string TQTEMPLATEId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TtTagWeb {\n");
            sb.Append("  Omschrijving: ").Append(Omschrijving).Append("\n");
            sb.Append("  TQTEMPLATEId: ").Append(TQTEMPLATEId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
