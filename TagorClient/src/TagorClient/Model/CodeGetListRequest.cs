...
namespace TagorClient.Model
{
    ...
    /// CodeGetListRequest
    /// </summary>
    [DataContract(Name = "CodeGetList_request")]
    public partial class CodeGetListRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CodeGetListRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public CodeGetListRequest(CodeGetListRequestRequest request = default(CodeGetListRequestRequest))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CodeGetListRequest {\n");
