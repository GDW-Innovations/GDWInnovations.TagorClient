...
namespace TagorClient.Model
{
    ...
    /// DsTDOSLIJNWeb
    /// </summary>
    [DataContract(Name = "dsTDOSLIJNWeb")]
    public partial class DsTDOSLIJNWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSLIJNWeb" /> class.
        /// </summary>
        /// <param name="varDsTDOSLIJNWeb">varDsTDOSLIJNWeb.</param>
        public DsTDOSLIJNWeb(DsTDOSLIJNWebDsTDOSLIJNWeb varDsTDOSLIJNWeb = default(DsTDOSLIJNWebDsTDOSLIJNWeb))
        {
            this.VarDsTDOSLIJNWeb = varDsTDOSLIJNWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTDOSLIJNWeb
        /// </summary>
        [DataMember(Name = "dsTDOSLIJNWeb", EmitDefaultValue = false)]
        public DsTDOSLIJNWebDsTDOSLIJNWeb VarDsTDOSLIJNWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSLIJNWeb {\n");
            sb.Append("  VarDsTDOSLIJNWeb: ").Append(VarDsTDOSLIJNWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
