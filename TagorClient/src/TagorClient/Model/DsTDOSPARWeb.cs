...
namespace TagorClient.Model
{
    ...
    /// DsTDOSPARWeb
    /// </summary>
    [DataContract(Name = "dsTDOSPARWeb")]
    public partial class DsTDOSPARWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSPARWeb" /> class.
        /// </summary>
        /// <param name="varDsTDOSPARWeb">varDsTDOSPARWeb.</param>
        public DsTDOSPARWeb(DsTDOSPARWebDsTDOSPARWeb varDsTDOSPARWeb = default(DsTDOSPARWebDsTDOSPARWeb))
        {
            this.VarDsTDOSPARWeb = varDsTDOSPARWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTDOSPARWeb
        /// </summary>
        [DataMember(Name = "dsTDOSPARWeb", EmitDefaultValue = false)]
        public DsTDOSPARWebDsTDOSPARWeb VarDsTDOSPARWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSPARWeb {\n");
            sb.Append("  VarDsTDOSPARWeb: ").Append(VarDsTDOSPARWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
