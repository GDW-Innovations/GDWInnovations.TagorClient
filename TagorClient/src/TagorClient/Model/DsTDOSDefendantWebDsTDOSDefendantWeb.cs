...
{
    /// <summary>
    /// DsTDOSDefendantWebDsTDOSDefendantWeb
    /// </summary>
    [DataContract(Name = "dsTDOSDefendantWeb_dsTDOSDefendantWeb")]
    public partial class DsTDOSDefendantWebDsTDOSDefendantWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSDefendantWebDsTDOSDefendantWeb" /> class.
        /// </summary>
        /// <param name="ttTDOSDefendantWeb">ttTDOSDefendantWeb.</param>
        public DsTDOSDefendantWebDsTDOSDefendantWeb(List<DsTDOSDefendantWebDsTDOSDefendantWebTtTDOSDefendantWebInner> ttTDOSDefendantWeb = default(List<DsTDOSDefendantWebDsTDOSDefendantWebTtTDOSDefendantWebInner>))
        {
            this.TtTDOSDefendantWeb = ttTDOSDefendantWeb;
        }

        /// <summary>
        /// Gets or Sets TtTDOSDefendantWeb
        /// </summary>
        [DataMember(Name = "ttTDOSDefendantWeb", EmitDefaultValue = false)]
        public List<DsTDOSDefendantWebDsTDOSDefendantWebTtTDOSDefendantWebInner> TtTDOSDefendantWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSDefendantWebDsTDOSDefendantWeb {\n");
            sb.Append("  TtTDOSDefendantWeb: ").Append(TtTDOSDefendantWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
