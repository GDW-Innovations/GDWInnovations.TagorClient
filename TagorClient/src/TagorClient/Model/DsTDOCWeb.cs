...
namespace TagorClient.Model
{
    ...
    /// DsTDOCWeb
    /// </summary>
    [DataContract(Name = "dsTDOCWeb")]
    public partial class DsTDOCWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOCWeb" /> class.
        /// </summary>
        /// <param name="varDsTDOCWeb">varDsTDOCWeb.</param>
        public DsTDOCWeb(DsTDOCWebDsTDOCWeb varDsTDOCWeb = default(DsTDOCWebDsTDOCWeb))
        {
            this.VarDsTDOCWeb = varDsTDOCWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsTDOCWeb
        /// </summary>
        [DataMember(Name = "dsTDOCWeb", EmitDefaultValue = false)]
        public DsTDOCWebDsTDOCWeb VarDsTDOCWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOCWeb {\n");
            sb.Append("  VarDsTDOCWeb: ").Append(VarDsTDOCWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
