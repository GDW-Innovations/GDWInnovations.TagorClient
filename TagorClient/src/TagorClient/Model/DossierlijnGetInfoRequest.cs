...
{
    /// <summary>
    /// DossierlijnGetInfoRequest
    /// </summary>
    [DataContract(Name = "DossierlijnGetInfo_request")]
    public partial class DossierlijnGetInfoRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierlijnGetInfoRequest" /> class.
        /// </summary>
        /// <param name="request">request.</param>
        public DossierlijnGetInfoRequest(CodeGetListRequestRequest request = default(CodeGetListRequestRequest))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierlijnGetInfoRequest {\n");
