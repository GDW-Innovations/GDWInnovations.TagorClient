...
{
    /// <summary>
    /// DossierAddAttachmentRequestRequest
    /// </summary>
    [DataContract(Name = "DossierAddAttachment_request_request")]
    public partial class DossierAddAttachmentRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierAddAttachmentRequestRequest" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsAttachmentWeb">dsAttachmentWeb.</param>
        public DossierAddAttachmentRequestRequest(DsWebContext dsWebContext = default(DsWebContext), DsAttachmentWeb dsAttachmentWeb = default(DsAttachmentWeb))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierAddAttachmentRequestRequest {\n");
