...
{
    /// <summary>
    /// DsTDOSCorrespondenceWebDsTDOSCorrespondenceWebTtTDOSCorrespondenceWebInner
    /// </summary>
    [DataContract(Name = "dsTDOSCorrespondenceWeb_dsTDOSCorrespondenceWeb_ttTDOSCorrespondenceWeb_inner")]
    public partial class DsTDOSCorrespondenceWebDsTDOSCorrespondenceWebTtTDOSCorrespondenceWebInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsTDOSCorrespondenceWebDsTDOSCorrespondenceWebTtTDOSCorrespondenceWebInner" /> class.
        /// </summary>
        /// <param name="tDOSId">tDOSId.</param>
        /// <param name="omschrijving">omschrijving.</param>
        /// <param name="datumInfo">datumInfo.</param>
        public DsTDOSCorrespondenceWebDsTDOSCorrespondenceWebTtTDOSCorrespondenceWebInner(string tDOSId = default(string), string omschrijving = default(string), DateOnly datumInfo = default(DateOnly))
        {
            this.TDOSId = tDOSId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsTDOSCorrespondenceWebDsTDOSCorrespondenceWebTtTDOSCorrespondenceWebInner {\n");
