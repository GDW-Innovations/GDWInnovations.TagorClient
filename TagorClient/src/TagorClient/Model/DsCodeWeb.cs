...
namespace TagorClient.Model
{
    ...
    /// DsCodeWeb
    /// </summary>
    [DataContract(Name = "dsCodeWeb")]
    public partial class DsCodeWeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsCodeWeb" /> class.
        /// </summary>
        /// <param name="varDsCodeWeb">varDsCodeWeb.</param>
        public DsCodeWeb(DsCodeWebDsCodeWeb varDsCodeWeb = default(DsCodeWebDsCodeWeb))
        {
            this.VarDsCodeWeb = varDsCodeWeb;
        }

        /// <summary>
        /// Gets or Sets VarDsCodeWeb
        /// </summary>
        [DataMember(Name = "dsCodeWeb", EmitDefaultValue = false)]
        public DsCodeWebDsCodeWeb VarDsCodeWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsCodeWeb {\n");
            sb.Append("  VarDsCodeWeb: ").Append(VarDsCodeWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
