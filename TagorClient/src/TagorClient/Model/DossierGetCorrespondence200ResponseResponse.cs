...
{
    /// <summary>
    /// DossierGetCorrespondence200ResponseResponse
    /// </summary>
    [DataContract(Name = "DossierGetCorrespondence_200_response_response")]
    public partial class DossierGetCorrespondence200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierGetCorrespondence200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTDOSINFOWeb">dsTDOSINFOWeb.</param>
        public DossierGetCorrespondence200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTDOSCorrespondenceWeb dsTDOSINFOWeb = default(DsTDOSCorrespondenceWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTDOSINFOWeb = dsTDOSINFOWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTDOSINFOWeb
        /// </summary>
        [DataMember(Name = "dsTDOSINFOWeb", EmitDefaultValue = false)]
        public DsTDOSCorrespondenceWeb DsTDOSINFOWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierGetCorrespondence200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTDOSINFOWeb: ").Append(DsTDOSINFOWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
