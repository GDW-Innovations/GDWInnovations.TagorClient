...
namespace TagorClient.Model
{
    ...
    /// DsCodetabelIDs
    /// </summary>
    [DataContract(Name = "dsCodetabelIDs")]
    public partial class DsCodetabelIDs : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DsCodetabelIDs" /> class.
        /// </summary>
        /// <param name="varDsCodetabelIDs">varDsCodetabelIDs.</param>
        public DsCodetabelIDs(DsCodetabelIDsDsCodetabelIDs varDsCodetabelIDs = default(DsCodetabelIDsDsCodetabelIDs))
        {
            this.VarDsCodetabelIDs = varDsCodetabelIDs;
        }

        /// <summary>
        /// Gets or Sets VarDsCodetabelIDs
        /// </summary>
        [DataMember(Name = "dsCodetabelIDs", EmitDefaultValue = false)]
        public DsCodetabelIDsDsCodetabelIDs VarDsCodetabelIDs { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DsCodetabelIDs {\n");
            sb.Append("  VarDsCodetabelIDs: ").Append(VarDsCodetabelIDs).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
