...
{
    /// <summary>
    /// ConfigInfo200ResponseResponse
    /// </summary>
    [DataContract(Name = "ConfigInfo_200_response_response")]
    public partial class ConfigInfo200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigInfo200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsTDOSPARWeb">dsTDOSPARWeb.</param>
        public ConfigInfo200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsTDOSPARWeb dsTDOSPARWeb = default(DsTDOSPARWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsTDOSPARWeb = dsTDOSPARWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsTDOSPARWeb
        /// </summary>
        [DataMember(Name = "dsTDOSPARWeb", EmitDefaultValue = false)]
        public DsTDOSPARWeb DsTDOSPARWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConfigInfo200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsTDOSPARWeb: ").Append(DsTDOSPARWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
