...
{
    /// <summary>
    /// UserGetPermissions200ResponseResponse
    /// </summary>
    [DataContract(Name = "UserGetPermissions_200_response_response")]
    public partial class UserGetPermissions200ResponseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGetPermissions200ResponseResponse" /> class.
        /// </summary>
        /// <param name="dsWebContext">dsWebContext.</param>
        /// <param name="dsConfigWeb">dsConfigWeb.</param>
        public UserGetPermissions200ResponseResponse(DsWebContext dsWebContext = default(DsWebContext), DsConfigWeb dsConfigWeb = default(DsConfigWeb))
        {
            this.DsWebContext = dsWebContext;
            this.DsConfigWeb = dsConfigWeb;
        }
        ...
        /// <summary>
        /// Gets or Sets DsConfigWeb
        /// </summary>
        [DataMember(Name = "dsConfigWeb", EmitDefaultValue = false)]
        public DsConfigWeb DsConfigWeb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserGetPermissions200ResponseResponse {\n");
            sb.Append("  DsWebContext: ").Append(DsWebContext).Append("\n");
            sb.Append("  DsConfigWeb: ").Append(DsConfigWeb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
