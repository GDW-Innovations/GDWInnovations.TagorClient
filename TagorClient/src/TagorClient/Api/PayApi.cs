...
namespace TagorClient.Api
{
    ...
    public partial class PayApi : IPayApi
    {
        ...
        /// <returns></returns>
        public PayApi(TagorClient.Client.Configuration configuration)
        {
        ...
        public PayApi(TagorClient.Client.ISynchronousClient client, TagorClient.Client.IAsynchronousClient asyncClient, TagorClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TagorClient.Client.ApiResponse<Object> PayFinishWithHttpInfo(string? redirectUrl = default(string?), string? seal = default(string?), string? interfaceVersion = default(string?), string? locale = default(string?), string? data = default(string?), int operationIndex = 0)
        {
            ...
            if (redirectUrl != null)
            {
                localVarRequestOptions.QueryParameters.Add(TagorClient.Client.ClientUtils.ParameterToMultiMap("", "redirectUrl", redirectUrl));
            }
            if (seal != null)
            {
                localVarRequestOptions.FormParameters.Add("Seal", TagorClient.Client.ClientUtils.ParameterToString(seal)); // form parameter
            }
            if (interfaceVersion != null)
            {
                localVarRequestOptions.FormParameters.Add("InterfaceVersion", TagorClient.Client.ClientUtils.ParameterToString(interfaceVersion)); // form parameter
            }
            if (locale != null)
            {
                localVarRequestOptions.FormParameters.Add("locale", TagorClient.Client.ClientUtils.ParameterToString(locale)); // form parameter
            }
            if (data != null)
            {
                localVarRequestOptions.FormParameters.Add("Data", TagorClient.Client.ClientUtils.ParameterToString(data)); // form parameter
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TagorClient.Client.ApiResponse<Object>> PayFinishWithHttpInfoAsync(string? redirectUrl = default(string?), string? seal = default(string?), string? interfaceVersion = default(string?), string? locale = default(string?), string? data = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        {
            TagorClient.Client.ApiResponse<PayStart200Response> localVarResponse = PayStartWithHttpInfo(payStartRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PayStart200Response</returns>
        public TagorClient.Client.ApiResponse<PayStart200Response> PayStartWithHttpInfo(PayStartRequest? payStartRequest = default(PayStartRequest?), int operationIndex = 0)
        {
            TagorClient.Client.RequestOptions localVarRequestOptions = new TagorClient.Client.RequestOptions();
        ...
        {
            TagorClient.Client.ApiResponse<PayStart200Response> localVarResponse = await PayStartWithHttpInfoAsync(payStartRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PayStart200Response)</returns>
        public async System.Threading.Tasks.Task<TagorClient.Client.ApiResponse<PayStart200Response>> PayStartWithHttpInfoAsync(PayStartRequest? payStartRequest = default(PayStartRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
