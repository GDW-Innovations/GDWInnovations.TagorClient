...
namespace TagorClient.Api
{
    ...
    public partial class CodeApi : ICodeApi
    {
        ...
        /// <returns></returns>
        public CodeApi(TagorClient.Client.Configuration configuration)
        {
        ...
        public CodeApi(TagorClient.Client.ISynchronousClient client, TagorClient.Client.IAsynchronousClient asyncClient, TagorClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            TagorClient.Client.ApiResponse<CodeGetDescription200Response> localVarResponse = CodeGetDescriptionWithHttpInfo(codeGetDescriptionRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CodeGetDescription200Response</returns>
        public TagorClient.Client.ApiResponse<CodeGetDescription200Response> CodeGetDescriptionWithHttpInfo(CodeGetDescriptionRequest? codeGetDescriptionRequest = default(CodeGetDescriptionRequest?), int operationIndex = 0)
        {
        ...
        {
            TagorClient.Client.ApiResponse<CodeGetDescription200Response> localVarResponse = await CodeGetDescriptionWithHttpInfoAsync(codeGetDescriptionRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CodeGetDescription200Response)</returns>
        public async System.Threading.Tasks.Task<TagorClient.Client.ApiResponse<CodeGetDescription200Response>> CodeGetDescriptionWithHttpInfoAsync(CodeGetDescriptionRequest? codeGetDescriptionRequest = default(CodeGetDescriptionRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        {
            TagorClient.Client.ApiResponse<CodeGetDescription200Response> localVarResponse = CodeGetListWithHttpInfo(codeGetListRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CodeGetDescription200Response</returns>
        public TagorClient.Client.ApiResponse<CodeGetDescription200Response> CodeGetListWithHttpInfo(CodeGetListRequest? codeGetListRequest = default(CodeGetListRequest?), int operationIndex = 0)
        {
            TagorClient.Client.RequestOptions localVarRequestOptions = new TagorClient.Client.RequestOptions();
        ...
        {
            TagorClient.Client.ApiResponse<CodeGetDescription200Response> localVarResponse = await CodeGetListWithHttpInfoAsync(codeGetListRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CodeGetDescription200Response)</returns>
        public async System.Threading.Tasks.Task<TagorClient.Client.ApiResponse<CodeGetDescription200Response>> CodeGetListWithHttpInfoAsync(CodeGetListRequest? codeGetListRequest = default(CodeGetListRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
